...
{
    public class WillDocValidatorConfiguration
    {
        public WillDocValidatorConfiguration()
        {
        ...
        {
            string validatorConfigurationString = Settings.WillDocValidatorConfiguration; //System.Configuration.ConfigurationManager.AppSettings["WillDocValidatorConfiguration"] as string;
        ...
        {
            //string appendErrorCode = System.Configuration.ConfigurationManager.AppSettings["AppendErrorCode"] as string;
