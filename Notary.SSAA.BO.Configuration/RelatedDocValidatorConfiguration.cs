...
{
    public class RelatedDocValidatorConfiguration
    {
        public RelatedDocValidatorConfiguration()
        {
        ...
        {
            string validatorConfigurationString = Settings.RelatedDocValidatorConfiguration; //System.Configuration.ConfigurationManager.AppSettings["RelatedDocValidatorConfiguration"] as string;
            if (string.IsNullOrWhiteSpace(validatorConfigurationString))
            {
                validatorConfigurationString = "D,A,A,A,A,A,A,A,A,A,W,W,W,W,W,W,W,A";
            }
        ...
        {
            string appendErrorCode = Settings.AppendErrorCode.ToString(); //System.Configuration.ConfigurationManager.AppSettings["AppendErrorCode"] as string;
            _ = bool.TryParse(appendErrorCode, out _appendErrorCode);

            string[] inputArray = input.Split(',');
            if (inputArray.Length < 18)
            {
