...
{
    public class DocumentEstateSeridaftarRepository : Repository<EstateSeridaftar> , IDocumentEstateSeridaftarRepository
    {
        public DocumentEstateSeridaftarRepository(ApplicationContext context) : base(context)
        {

        }
        public async Task<BaseLookupRepositoryObject> GetDocumentEstateSeridaftarLookupItems(int pageIndex, int pageSize, ICollection<SearchData> GridSearchInput, string GlobalSearch,
