...
{
    internal class EstateTaxInquiryBuildingStatusRepository : Repository<EstateTaxInquiryBuildingStatus>, IEstateTaxInquiryBuildingStatusRepository
    {
        public EstateTaxInquiryBuildingStatusRepository(ApplicationContext context) : base(context)
        {
        }

       
        public async Task<BaseLookupRepositoryObject> GetBuildingStatusItems(int pageIndex, int pageSize, ICollection<SearchData> GridSearchInput, string GlobalSearch,
