...
{
    internal class DocumentReliablePersonReasonRepository : Repository<ReliablePersonReason>, IDocumentReliablePersonReasonRepository
    {
        public DocumentReliablePersonReasonRepository(ApplicationContext context) : base(context)
        {
        }

        public async Task<DocumentReliablePersonReasonLookupRepositoryObject> GetDocumentReliablePersonReasonLookupItems(int pageIndex, int pageSize,ICollection<SearchData> GridSearchInput, string GlobalSearch, 
