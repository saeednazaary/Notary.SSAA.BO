...
{
    internal class EstateTaxProvinceRepository : Repository<EstateTaxProvince>, IEstateTaxProvinceRepository
    {
        public EstateTaxProvinceRepository(ApplicationContext context) : base(context)
        {
        }

        public async Task<BaseLookupRepositoryObject> GetEstateTaxProvinceItems(int pageIndex, int pageSize,ICollection<SearchData> GridSearchInput, string GlobalSearch, 
