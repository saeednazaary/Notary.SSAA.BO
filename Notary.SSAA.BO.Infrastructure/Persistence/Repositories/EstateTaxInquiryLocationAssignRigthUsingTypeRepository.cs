...
{
    internal class EstateTaxInquiryLocationAssignRigthUsingTypeRepository : Repository<EstateTaxInquiryLocationAssignRigthUsingType>, IEstateTaxInquiryLocationAssignRigthUsingTypeRepository
    {
        public EstateTaxInquiryLocationAssignRigthUsingTypeRepository(ApplicationContext context) : base(context)
        {
        }

        public async Task<BaseLookupRepositoryObject> GetEstateTaxInquiryLocationAssignRigthUsingTypeItems(int pageIndex, int pageSize, ICollection<SearchData> gridSearchInput, string globalSearch, SortData gridSortInput, IList<string> selectedItemsIds, List<string> fieldsNotInFilterSearch, bool isOrderBy, CancellationToken cancellationToken)
        {
