...
{
    public class EstateOwnershipTypeRepository : Repository<EstateOwnershipType>, IEstateOwnershipTypeRepository
    {
        public EstateOwnershipTypeRepository(ApplicationContext dbContext) : base(dbContext)
        {
        }

        public async Task<BaseLookupRepositoryObject> GetEstateOwnershipTypeItems(int pageIndex, int pageSize, ICollection<SearchData> gridSearchInput, string globalSearch, SortData gridSortInput, IList<string> selectedItemsIds, List<string> fieldsNotInFilterSearch, bool isOrderBy, CancellationToken cancellationToken)
        {
