...
{
    public class EstateDocumentRequestTypeRepository:Repository<EstateDocumentRequestType>,IEstateDocumentRequestTypeRepository
    {
        public EstateDocumentRequestTypeRepository(ApplicationContext dbContext) : base(dbContext)
        {

        }
        public async Task<BaseLookupRepositoryObject> GetEstateDocumentRequestTypeItems(int pageIndex, int pageSize, ICollection<SearchData> gridSearchInput, string globalSearch, SortData gridSortInput, IList<string> selectedItemsIds, List<string> fieldsNotInFilterSearch, bool isOrderBy, CancellationToken cancellationToken)
        {
