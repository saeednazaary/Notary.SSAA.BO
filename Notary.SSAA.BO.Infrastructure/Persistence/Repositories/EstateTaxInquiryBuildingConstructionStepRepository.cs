...
{
    internal class EstateTaxInquiryBuildingConstructionStepRepository : Repository<EstateTaxInquiryBuildingConstructionStep>, IEstateTaxInquiryBuildingConstructionStepRepository
    {
        public EstateTaxInquiryBuildingConstructionStepRepository(ApplicationContext context) : base(context)
        {
        }

       
        public async Task<BaseLookupRepositoryObject> GetBuildingConstructionStepItems(int pageIndex, int pageSize, ICollection<SearchData> GridSearchInput, string GlobalSearch,
