...
{
    internal class EstateTaxInquiryFieldTypeRepository : Repository<EstateTaxInquiryFieldType>, IEstateTaxInquiryFieldTypeRepository
    {
        public EstateTaxInquiryFieldTypeRepository(ApplicationContext context) : base(context)
        {
        }

        public async Task<BaseLookupRepositoryObject> GetEstateTaxInquiryFieldTypeItems(int pageIndex, int pageSize,ICollection<SearchData> GridSearchInput, string GlobalSearch, 
