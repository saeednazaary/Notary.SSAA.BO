...
{
    internal class EstateTaxInquiryLocationAssignRigthOwnershipTypeRepository : Repository<EstateTaxInquiryLocationAssignRigthOwnershipType>, IEstateTaxInquiryLocationAssignRigthOwnershipTypeRepository
    {
        public EstateTaxInquiryLocationAssignRigthOwnershipTypeRepository(ApplicationContext context) : base(context)
        {
        }

        public async Task<BaseLookupRepositoryObject> GetEstateTaxInquiryLocationAssignRigthOwnershipTypeItems(int pageIndex, int pageSize, ICollection<SearchData> gridSearchInput, string globalSearch, SortData gridSortInput, IList<string> selectedItemsIds, List<string> fieldsNotInFilterSearch, bool isOrderBy, CancellationToken cancellationToken)
        {
