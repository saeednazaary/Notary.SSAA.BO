...
{
    internal class DocumentEstateTypeGroupRepository : Repository<DocumentEstateTypeGroup>, IDocumentEstateTypeGroupRepository
    {
        public DocumentEstateTypeGroupRepository(ApplicationContext context) : base(context)
        {
        }

        public async Task<BaseLookupRepositoryObject> GetDocumentEstateTypeGroupLookupItems(int pageIndex, int pageSize,ICollection<SearchData> GridSearchInput, string GlobalSearch, 
