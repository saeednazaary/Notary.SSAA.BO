...
{
    internal class EstateSideTypeRepository : Repository<EstateSideType>, IEstateSideTypeRepository
    {
        public EstateSideTypeRepository(ApplicationContext context) : base(context)
        {
        }

        public async Task<BaseLookupRepositoryObject> GetEstateSideTypeItems(int pageIndex, int pageSize,ICollection<SearchData> GridSearchInput, string GlobalSearch, 
