...
{
    public class DocumentEstateSubsectionRepository : Repository<EstateSubsection> , IDocumentEstateSubsectionRepository
    {
        public DocumentEstateSubsectionRepository(ApplicationContext context) : base(context)
        {

        }
        public async Task<BaseLookupRepositoryObject> GetDocumentEstateSubsectionLookupItems(int pageIndex, int pageSize, ICollection<SearchData> GridSearchInput, string GlobalSearch,
