        ...
        private async Task InitializeUserContextAsync()
        {
            ...
            if (!string.IsNullOrEmpty(info))
            {
                ...
                if (decrypted != null)
                {
                    ...
                    ApplicationBranchAccess branchAccessFromInfo = new(branchAccessIdFromInfo, branchIdFromInfo, branchCodeFromInfo, branchNameFromInfo, branchAccessDisplayNameFromInfo);
                ...
                else
                {
                    ...
                    ApplicationBranchAccess branchAccess = new(branchAccessId, branchId, branchCode, branchName, branchAccessDisplayName);
                    if ( applicationUserName == "Administrator" || applicationUserName == null )
                    {
