...
/// <summary>
/// اشخاص تقاضانامه اجرائیه برون سپاری شده به دفترخانه
/// </summary>
[Table("EXECUTIVE_REQUEST_PERSON")]
[Index("CompanyType", Name = "IDX_EXECUTIVE_REQUEST_PERSON###COMPANY_TYPE")]
[Index("ExecutiveAddressTypeId", Name = "IDX_EXECUTIVE_REQUEST_PERSON###EXECUTIVE_ADDRESS_TYPE_ID")]
[Index("ExecutivePersonPostTypeId", Name = "IDX_EXECUTIVE_REQUEST_PERSON###EXECUTIVE_PERSON_POST_TYPE_ID")]
[Index("HasSana", Name = "IDX_EXECUTIVE_REQUEST_PERSON###HAS_SANA")]
[Index("Ilm", Name = "IDX_EXECUTIVE_REQUEST_PERSON###ILM")]
[Index("IsAlive", Name = "IDX_EXECUTIVE_REQUEST_PERSON###IS_ALIVE")]
[Index("IsFingerprintGotten", Name = "IDX_EXECUTIVE_REQUEST_PERSON###IS_FINGERPRINT_GOTTEN")]
[Index("IsIranian", Name = "IDX_EXECUTIVE_REQUEST_PERSON###IS_IRANIAN")]
[Index("IsOriginal", Name = "IDX_EXECUTIVE_REQUEST_PERSON###IS_ORIGINAL")]
[Index("IsRelated", Name = "IDX_EXECUTIVE_REQUEST_PERSON###IS_RELATED")]
[Index("IsSabtahvalChecked", Name = "IDX_EXECUTIVE_REQUEST_PERSON###IS_SABTAHVAL_CHECKED")]
[Index("IsSabtahvalCorrect", Name = "IDX_EXECUTIVE_REQUEST_PERSON###IS_SABTAHVAL_CORRECT")]
[Index("LegalpersonNatureId", Name = "IDX_EXECUTIVE_REQUEST_PERSON###LEGALPERSON_NATURE_ID")]
[Index("LegalpersonTypeId", Name = "IDX_EXECUTIVE_REQUEST_PERSON###LEGALPERSON_TYPE_ID")]
[Index("MobileNo", Name = "IDX_EXECUTIVE_REQUEST_PERSON###MOBILE_NO")]
[Index("NationalityId", Name = "IDX_EXECUTIVE_REQUEST_PERSON###NATIONALITY_ID")]
[Index("NationalNo", Name = "IDX_EXECUTIVE_REQUEST_PERSON###NATIONAL_NO")]
[Index("PersonType", Name = "IDX_EXECUTIVE_REQUEST_PERSON###PERSON_TYPE")]
[Index("RowNo", Name = "IDX_EXECUTIVE_REQUEST_PERSON###ROW_NO")]
[Index("ScriptoriumId", Name = "IDX_EXECUTIVE_REQUEST_PERSON###SCRIPTORIUM_ID")]
[Index("ExecutiveRequestId", "RowNo", Name = "UDX_EXECUTIVE_REQUEST_PERSON###EXECUTIVE_REQUEST_ID#ROW_NO", IsUnique = true)]
[Index("LegacyId", Name = "UDX_EXECUTIVE_REQUEST_PERSON###LEGACY_ID", IsUnique = true)]
public partial class ExecutiveRequestPerson
{
    /// <summary>
    /// شناسه
    /// </summary>
    ...
    [InverseProperty("ExecutiveRequestPeople")]
    ...
    public virtual ICollection<ExecutiveRequestPersonRelated> ExecutiveRequestPersonRelatedAgentPeople { get; set; } = new List<ExecutiveRequestPersonRelated>();

    [InverseProperty("MainPerson")]
    public virtual ICollection<ExecutiveRequestPersonRelated> ExecutiveRequestPersonRelatedMainPeople { get; set; } = new List<ExecutiveRequestPersonRelated>();
}
