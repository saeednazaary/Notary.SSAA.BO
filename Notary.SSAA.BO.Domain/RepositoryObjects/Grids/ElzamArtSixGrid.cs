...
{
    public class ElzamArtSixGrid
    {
        public ElzamArtSixGrid()
        {
            GridItems = new();
            SelectedItems = new();
        }
        public int? TotalCount { get; set; }
        public List<ElzamArtSixGridItem> GridItems { get; set; }
        public List<ElzamArtSixGridItem> SelectedItems { get; set; }
    }

    public class ElzamArtSixGridExtraParams
    {
