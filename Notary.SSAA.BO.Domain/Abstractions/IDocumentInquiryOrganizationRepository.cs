...
{
    public interface IDocumentInquiryOrganizationRepository : IRepository<DocumentInquiryOrganization>
    {
        Task<BaseLookupRepositoryObject> GetDocumentInquiryOrganizationLookupItems
