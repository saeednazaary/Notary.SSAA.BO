...
{
    public interface IDocumentEstateSubsectionRepository:IRepository<EstateSubsection>
    {
        Task<BaseLookupRepositoryObject> GetDocumentEstateSubsectionLookupItems
