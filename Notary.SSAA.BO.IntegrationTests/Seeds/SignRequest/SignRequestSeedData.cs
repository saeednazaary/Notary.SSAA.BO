...
namespace Notary.SSAA.BO.FunctionalTests.Seeds.SignRequestSeedData
{
    ...
    public static class SignRequestSeedData
    {
        public static CreateSignRequestCommand CreateSignRequestCommand { get; set; } = new()
        {
            ...
            IsDelete = false,
            IsDirty = false,
            SignRequestGetterId = new List<string> { "0101" },
            ...
            SignRequestRelatedPersons = new List<ToRelatedPersonViewModel>
 {
     new ToRelatedPersonViewModel
     {
        ...
        public static List<PersonFingerprint> GetPersonFingerPrints()
        {
        ...
        public static List<PersonFingerprintUseCase> GetPersonFingerprintUseCases()
        {
        ...
        public static List<PersonFingerType> GetPersonFingerTypes()
        {
            return new List<PersonFingerType>
            {
                new PersonFingerType
                {
                    Id = "10",
                    Code = "10",
                    Title = "انگشت کوچک دست چپ",
                    State = "1",
                    SabtahvalCode = "10"
                },
                new PersonFingerType
                ...
                new PersonFingerType
                {
                    Id = "18",
                    Code = "18",
                    Title = "انگشت کنار انگشت کوچک پاي چپ",
                    State = "1",
                    SabtahvalCode = "18"
                },
                new PersonFingerType
                {
                    Id = "17",
                    Code = "17",
                    Title = "انگشت کنار انگشت کوچک پاي راست",
                    State = "1",
                    SabtahvalCode = "17"
                },
                new PersonFingerType
                ...
                new PersonFingerType
                {
                    Id = "3",
                    Code = "03",
                    Title = "انگشت مياني دست راست",
                    State = "1",
                    SabtahvalCode = "3"
                }
            };
        }
        public static UpdateSignRequestCommand UpdatePeopleOfSignRequestCommand = new UpdateSignRequestCommand
        {
            IsValid = true,
            IsNew = false,
            IsDirty = false,
