...
{
    internal class UpdateDocumentAfterPaidCommandHandler : BaseCommandHandler<UpdateDocumentAfterPaidCommand, ApiResult<UpdateDocumentAfterPaidViewModel>>
    {
        private Domain.Entities.Document masterEntity;
        private readonly IDocumentRepository _documentRepository;
        private ApiResult<UpdateDocumentAfterPaidViewModel> apiResult;
        ...
        public UpdateDocumentAfterPaidCommandHandler(IMediator mediator, IUserService userService, IDocumentRepository documentRepository,
        ...
        protected override bool HasAccess(UpdateDocumentAfterPaidCommand request, IList<string> userRoles)
        {
        ...
        protected override async Task<ApiResult<UpdateDocumentAfterPaidViewModel>> ExecuteAsync(UpdateDocumentAfterPaidCommand request, CancellationToken cancellationToken)
        {
