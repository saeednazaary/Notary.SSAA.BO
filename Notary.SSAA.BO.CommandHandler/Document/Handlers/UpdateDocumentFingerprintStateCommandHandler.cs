...
{
    internal class UpdateDocumentFingerprintStateCommandHandler : BaseCommandHandler<UpdateDocumentFingerprintStateCommand, ApiResult<DocumentViewModel>>
    {
        private Domain.Entities.Document masterEntity;
        private readonly IDocumentRepository _DocumentRepository;
        private ApiResult<DocumentViewModel> apiResult;

        public UpdateDocumentFingerprintStateCommandHandler(IMediator mediator, IUserService userService, ILogger logger, IDocumentRepository DocumentRepository)
        ...
        protected override async Task<ApiResult<DocumentViewModel>> ExecuteAsync(UpdateDocumentFingerprintStateCommand request, CancellationToken cancellationToken)
        {
        ...
        protected override bool HasAccess(UpdateDocumentFingerprintStateCommand request, IList<string> userRoles)
        {
