...
{
    internal class UndoPersonFingerprintCommandHandler : BaseCommandHandler<UndoPersonFingerprintCommand, ApiResult>
    {
        ...
        protected async override Task<ApiResult> ExecuteAsync(UndoPersonFingerprintCommand request, CancellationToken cancellationToken)
        {
        ...
        protected override bool HasAccess(UndoPersonFingerprintCommand request, IList<string> userRoles)
        {
