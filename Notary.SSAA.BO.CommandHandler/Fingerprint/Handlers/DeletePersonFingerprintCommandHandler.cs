...
{
    internal class DeletePersonFingerprintCommandHandler : BaseCommandHandler<DeletePersonFingerprintCommand, ApiResult>
    {
        ...
        protected async override Task<ApiResult> ExecuteAsync(DeletePersonFingerprintCommand request, CancellationToken cancellationToken)
        {
        ...
        protected override bool HasAccess(DeletePersonFingerprintCommand request, IList<string> userRoles)
        {
