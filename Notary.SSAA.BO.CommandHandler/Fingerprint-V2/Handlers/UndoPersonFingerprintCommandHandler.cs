...
{
    internal class UndoPersonFingerprintCommandHandler : BaseCommandHandler<UndoPersonFingerprintV2Command, ApiResult>
    {
        ...
        public UndoPersonFingerprintCommandHandler(IMediator mediator, IUserService userService, ILogger logger,
        ...
        protected async override Task<ApiResult> ExecuteAsync(UndoPersonFingerprintV2Command request, CancellationToken cancellationToken)
        {
            ...
            {
                personFingerprint.IsDeleted = "2";
                personFingerprint.TfaState = "2";
        ...
        protected override bool HasAccess(UndoPersonFingerprintV2Command request, IList<string> userRoles)
        {
