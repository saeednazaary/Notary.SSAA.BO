...
{
    public class SignRequestSubjectLookupQueryHandler : BaseQueryHandler<SignRequestSubjectLookupQuery, ApiResult<BaseLookupRepositoryObject>>
    {
        ...
        protected override async Task<ApiResult<BaseLookupRepositoryObject>> RunAsync(SignRequestSubjectLookupQuery request, CancellationToken cancellationToken)
        {
            ...
            BaseLookupRepositoryObject result = await _signRequestSubjectRepository.GetSignRequestSubjectLookupItems(request.PageIndex, request.PageSize, request.GridFilterInput, request.GlobalSearch, gridSortInput, request.SelectedItems, FieldsNotInFilterSearch, cancellationToken, isOrderBy);
