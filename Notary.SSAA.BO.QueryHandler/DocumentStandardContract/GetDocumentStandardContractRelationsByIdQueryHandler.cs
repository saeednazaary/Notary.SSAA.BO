...
{
    public class GetDocumentStandardContractRelationsByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractRelationsByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractRelationsByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractRelationsByIdQuery request,
