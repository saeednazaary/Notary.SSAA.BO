...
{
    public class GetDocumentStandardContractRegisterReqPricesByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractRegisterReqPricesByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractRegisterReqPricesByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractRegisterReqPricesByIdQuery request,
        ...
        )
        {
            ...
            Domain.Entities.Document document = await _documentRepository.GetDocumentCostsAndCostUnchange(
