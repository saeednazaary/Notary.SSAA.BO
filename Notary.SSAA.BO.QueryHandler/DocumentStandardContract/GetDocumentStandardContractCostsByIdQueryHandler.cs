...
{
    public class GetDocumentStandardContractCostsByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractCostsByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractCostsByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractCostsByIdQuery request,
