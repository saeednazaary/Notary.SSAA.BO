...
{
    public class GetDocumentStandardContractCasesByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractCasesByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractCasesByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractCasesByIdQuery request,
        ...
        )
        {
            ...
            Domain.Entities.Document document = await _documentRepository.GetDocumentCases(
