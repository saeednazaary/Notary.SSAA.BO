...
{
    public class GetDocumentStandardContractInfoTextByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractInfoTextByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractInfoTextByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractInfoTextByIdQuery request,
        ...
        )
        {
            ...
            Domain.Entities.Document document = await _documentRepository.GetDocumentInfoTextById(
                request.DocumentId,
                cancellationToken
            );
            if (document != null)
