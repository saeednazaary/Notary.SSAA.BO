...
{
    public class GetDocumentStandardContractByIdQueryHandler : BaseQueryHandler<GetDocumentStandardContractByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractByIdQueryHandler(IMediator mediator, IUserService userService,
        ...
        protected override bool HasAccess(GetDocumentStandardContractByIdQuery request, IList<string> userRoles)
        {
        ...
        protected override async Task<ApiResult<DocumentStandardContractViewModel>> RunAsync(GetDocumentStandardContractByIdQuery request, CancellationToken cancellationToken)
        {
            ...
            if (document != null)
            {
                ...
                {
                    var paymentInquiryResult = await _mediator.Send(new UpdateDocumentStandardContractPaymentStateCommand() { DocumentNo = document.RequestNo, InquiryMode = true }, cancellationToken);
                ...
                //    saveDocument = DocumentStandardContractMapper.MapDocumentToSaveDocumentCommand(document);
