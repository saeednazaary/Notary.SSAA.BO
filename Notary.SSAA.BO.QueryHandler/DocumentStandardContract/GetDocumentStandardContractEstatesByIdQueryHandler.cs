...
{
    public class GetDocumentStandardContractEstatesByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractEstatesByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractEstatesByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractEstatesByIdQuery request,
        ...
        )
        {
            ...
            Domain.Entities.Document document = await _documentRepository.GetDocumentEstates(
