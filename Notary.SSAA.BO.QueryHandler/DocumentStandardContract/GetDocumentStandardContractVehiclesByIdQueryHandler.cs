...
{
    public class GetDocumentStandardContractVehiclesByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractVehiclesByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractVehiclesByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractVehiclesByIdQuery request,
        ...
        )
        {
            ...
            Domain.Entities.Document document = await _documentRepository.GetDocumentVehicles(
