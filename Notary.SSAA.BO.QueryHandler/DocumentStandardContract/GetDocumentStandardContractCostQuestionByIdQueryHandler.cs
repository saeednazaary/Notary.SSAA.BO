...
namespace Notary.SSAA.BO.QueryHandler.StandardContract
{
    public class GetDocumentStandardContractCostQuestionByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractCostQuestionByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractCostQuestionByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractCostQuestionByIdQuery request,
        ...
        )
        {
            ...
            Domain.Entities.Document document = await _documentRepository.GetDocumentCostQuestionById(
                request.DocumentId,
                cancellationToken
            );
            if (document != null)
            {
                ...
                DocumentStandardContractCostQuestionViewModel DocumentStandardContractCostQuestionViewModel = new()
                {
                    DocumentId = request.DocumentId,
                    IsRequestCostCalculateConfirmed = document?.IsCostCalculateConfirmed.ToNullabbleBoolean(),
                    IsEstateRegister = document?.DocumentInfoOther?.IsEstateRegistered.ToNullabbleBoolean(),
                    IsValid = true,
                    IsDelete=false,
                    IsDirty=false,
                    IsLoaded=false,
                ...
                result.DocumentCostQuestion= DocumentStandardContractCostQuestionViewModel;
                result.DocumentInfoOther = null;
