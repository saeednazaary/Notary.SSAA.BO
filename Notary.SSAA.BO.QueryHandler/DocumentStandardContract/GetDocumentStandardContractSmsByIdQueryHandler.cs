...
{
    public class GetDocumentStandardContractSmsByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractSmsByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractSmsByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractSmsByIdQuery request,
        ...
        )
        {
            ...
            Domain.Entities.Document document = await _documentRepository.GetDocumentSms(
