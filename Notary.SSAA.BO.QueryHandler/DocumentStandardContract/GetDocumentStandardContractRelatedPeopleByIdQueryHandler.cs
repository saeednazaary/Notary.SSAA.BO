...
{
    public class GetDocumentStandardContractRelatedPeopleByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractRelatedPeopleByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractRelatedPeopleByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractRelatedPeopleByIdQuery request,
        ...
        )
        {
            ...
            Domain.Entities.Document document = await _documentRepository.GetDocumentRelatedPeople(
