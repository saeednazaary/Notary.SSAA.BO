...
{
    public class GetDocumentStandardContractInfoOtherByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractInfoOtherByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractInfoOtherByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractInfoOtherByIdQuery request,
        ...
        )
        {
            ...
            Domain.Entities.Document document = await _documentRepository.GetDocumentInfoOther(
            ...
            if (document != null)
            {
                ...
                result.RequestType.AssetTypeId = ( result.DocumentInfoOther!=null && result.DocumentInfoOther.DocumentAssetTypeId != null && result.DocumentInfoOther.DocumentAssetTypeId.Count > 0 ) ? result.DocumentInfoOther.DocumentAssetTypeId [ 0 ] : null;
