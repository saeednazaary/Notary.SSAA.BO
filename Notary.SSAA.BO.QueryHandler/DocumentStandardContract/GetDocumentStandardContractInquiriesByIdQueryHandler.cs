...
{
    public class GetDocumentStandardContractInquiriesByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractInquiriesByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractInquiriesByIdQueryHandler (
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractInquiriesByIdQuery request,
        ...
        )
        {
            ...
            Domain.Entities.Document document = await _documentRepository.GetDocumentInquiries(
