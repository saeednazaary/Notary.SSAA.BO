...
{
    public class DocumentStandardContractPaymentsConfirmQueryHandler : BaseQueryHandler<DocumentStandardContractPaymentsConfirmQuery, ApiResult<DocumentStandardContractPaymentQuestionViewModel>>
    {
        ...
        public DocumentStandardContractPaymentsConfirmQueryHandler(IMediator mediator, IUserService userService, IDocumentRepository documentRepository,
        ...
        protected override bool HasAccess(DocumentStandardContractPaymentsConfirmQuery request, IList<string> userRoles)
        {
            return userRoles.Contains(RoleConstants.Sardaftar) || userRoles.Contains(RoleConstants.Daftaryar) || userRoles.Contains(RoleConstants.SanadNevis);
        }

        protected override async Task<ApiResult<DocumentStandardContractPaymentQuestionViewModel>> RunAsync(DocumentStandardContractPaymentsConfirmQuery request, CancellationToken cancellationToken)
        {
            DocumentStandardContractPaymentsConfirmQueryViewModel result = new();
            ApiResult<DocumentStandardContractPaymentQuestionViewModel> apiResult = new();
            ...
            if (document != null)
            {
                ...
                apiResult.Data = new DocumentStandardContractPaymentQuestionViewModel() { IsCostPaymentConfirmed = true };
