namespace Notary.SSAA.BO.QueryHandler.DocumentStandardContract
{
    ...
    /// <summary>
    /// Defines the <see cref="GetDocumentStandardContractDetailsQueryHandler" />
    /// </summary>
    public class GetDocumentStandardContractDetailsQueryHandler
        : BaseQueryHandler<GetDetailsOfDocumentStandardContractQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDocumentStandardContractDetailsQueryHandler"/> class.
        /// </summary>
        ...
        public GetDocumentStandardContractDetailsQueryHandler (
            IMediator mediator,
        ...
        /// The HasAccess
        /// </summary>
        /// <param name="request">The request<see cref="GetDetailsOfDocumentStandardContractQuery"/></param>
        /// <param name="userRoles">The userRoles<see cref="IList{string}"/></param>
        /// <returns>The <see cref="bool"/></returns>
        protected override bool HasAccess (
            GetDetailsOfDocumentStandardContractQuery request,
