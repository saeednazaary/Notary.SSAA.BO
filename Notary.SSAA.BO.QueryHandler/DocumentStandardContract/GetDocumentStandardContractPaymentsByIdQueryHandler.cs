...
namespace Notary.SSAA.BO.QueryHandler.DocumentStandardContractContractPayments
{
    public class GetDocumentStandardContractPaymentsByIdQueryHandler : BaseQueryHandler<GetDocumentStandardContractPaymentsByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractPaymentsByIdQueryHandler(IMediator mediator, IUserService userService, IDocumentRepository documentRepository,
        ...
        protected override bool HasAccess(GetDocumentStandardContractPaymentsByIdQuery request, IList<string> userRoles)
        {
            return userRoles.Contains(RoleConstants.Sardaftar) || userRoles.Contains(RoleConstants.Daftaryar) || userRoles.Contains(RoleConstants.SanadNevis);
        }

        protected override async Task<ApiResult<DocumentStandardContractViewModel>> RunAsync(GetDocumentStandardContractPaymentsByIdQuery request, CancellationToken cancellationToken)
        {
