...
{
    public class GetDocumentStandardContractJudgmentByIdQueryHandler
        : BaseQueryHandler<GetDocumentStandardContractInfoJudgmentByIdQuery, ApiResult<DocumentStandardContractViewModel>>
    {
        ...
        public GetDocumentStandardContractJudgmentByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentStandardContractInfoJudgmentByIdQuery request,
        ...
        )
        {
            ...
            Domain.Entities.Document document = await _documentRepository.GetDocumentInfoJudgmentById(
                request.DocumentId,
                cancellationToken
            );
            if (document != null)
