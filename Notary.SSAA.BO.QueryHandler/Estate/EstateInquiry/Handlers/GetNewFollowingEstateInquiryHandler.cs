...
{
    public class GetNewFollowingEstateInquiryHandler : BaseQueryHandler<GetNewFollowingEstateInquiryQuery, ApiResult<EstateInquiryViewModel>>
    {
        private readonly IEstateInquiryRepository _estateInquiryRepository;



        public GetNewFollowingEstateInquiryHandler(IMediator mediator, IUserService userService,
        ...
        protected override bool HasAccess(GetNewFollowingEstateInquiryQuery request, IList<string> userRoles)
        {
            return userRoles.Contains(RoleConstants.Sardaftar) || userRoles.Contains(RoleConstants.Daftaryar) || userRoles.Contains(RoleConstants.SanadNevis);
        }

        protected async override Task<ApiResult<EstateInquiryViewModel>> RunAsync(GetNewFollowingEstateInquiryQuery request, CancellationToken cancellationToken)
        {
            ...
            if (estateInquiry != null)
            {
                ...
                result.InqEstateInquiryId = new List<string> { estateInquiry.Id.ToString() };
