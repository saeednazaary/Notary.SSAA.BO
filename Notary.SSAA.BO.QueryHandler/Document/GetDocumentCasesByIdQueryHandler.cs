...
{
    public class GetDocumentCasesByIdQueryHandler
        : BaseQueryHandler<GetDocumentCasesByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentCasesByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentCasesByIdQuery request,
