...
{
    public class GetDocumentVehiclesByIdQueryHandler
        : BaseQueryHandler<GetDocumentVehiclesByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentVehiclesByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentVehiclesByIdQuery request,
