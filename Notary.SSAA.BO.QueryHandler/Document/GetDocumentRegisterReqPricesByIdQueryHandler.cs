...
{
    public class GetDocumentRegisterReqPricesByIdQueryHandler
        : BaseQueryHandler<GetDocumentRegisterReqPricesByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentRegisterReqPricesByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentRegisterReqPricesByIdQuery request,
