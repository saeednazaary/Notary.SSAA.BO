...
{
    public class GetDocumentEstatesByIdQueryHandler
        : BaseQueryHandler<GetDocumentEstatesByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentEstatesByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentEstatesByIdQuery request,
