...
{
    public class GetDocumentCostsByIdQueryHandler
        : BaseQueryHandler<GetDocumentCostsByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentCostsByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentCostsByIdQuery request,
