...
{
    public class GetDocumentJudgmentByIdQueryHandler
        : BaseQueryHandler<GetDocumentInfoJudgmentByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentJudgmentByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentInfoJudgmentByIdQuery request,
