...
{
    public class GetDocumentInfoOtherByIdQueryHandler
        : BaseQueryHandler<GetDocumentInfoOtherByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentInfoOtherByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentInfoOtherByIdQuery request,
