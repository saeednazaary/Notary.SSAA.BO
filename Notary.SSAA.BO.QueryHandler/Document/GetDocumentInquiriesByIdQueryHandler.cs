...
{
    public class GetDocumentInquiriesByIdQueryHandler
        : BaseQueryHandler<GetDocumentInquiriesByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentInquiriesByIdQueryHandler (
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentInquiriesByIdQuery request,
