...
{
    public class GetDocumentPeopleByIdQueryHandler
        : BaseQueryHandler<GetDocumentPeopleByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentPeopleByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentPeopleByIdQuery request,
        ...
        )
        {
            ...
            if (document != null)
            {
                ...
                result.DocumentRelatedPeople = new List<DocumentRelatedPersonViewModel>();
