...
{
    public class DocumentPaymentsByIdQueryHandler : BaseQueryHandler<GetDocumentPaymentsByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public DocumentPaymentsByIdQueryHandler(IMediator mediator, IUserService userService, IDocumentRepository documentRepository,
        ...
        protected override bool HasAccess(GetDocumentPaymentsByIdQuery request, IList<string> userRoles)
        {
            return userRoles.Contains(RoleConstants.Sardaftar) || userRoles.Contains(RoleConstants.Daftaryar) || userRoles.Contains(RoleConstants.SanadNevis);
        }

        protected override async Task<ApiResult<DocumentViewModel>> RunAsync(GetDocumentPaymentsByIdQuery request, CancellationToken cancellationToken)
        {
