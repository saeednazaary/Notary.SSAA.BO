...
{
    public class GetDocumentRelatedPeopleByIdQueryHandler
        : BaseQueryHandler<GetDocumentRelatedPeopleByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentRelatedPeopleByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentRelatedPeopleByIdQuery request,
