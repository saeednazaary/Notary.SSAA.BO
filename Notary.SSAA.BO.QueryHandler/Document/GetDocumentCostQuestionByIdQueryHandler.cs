...
{
    public class GetDocumentCostQuestionByIdQueryHandler
        : BaseQueryHandler<GetDocumentCostQuestionByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentCostQuestionByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentCostQuestionByIdQuery request,
        ...
        )
        {
            ...
            if (document != null)
            {
                ...
                DocumentCostQuestionViewModel documentCostQuestionViewModel = new()
                {
                ...
                result.DocumentCostQuestion= documentCostQuestionViewModel;
