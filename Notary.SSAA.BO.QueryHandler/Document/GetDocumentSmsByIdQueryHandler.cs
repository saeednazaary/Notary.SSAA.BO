...
{
    public class GetDocumentSmsByIdQueryHandler
        : BaseQueryHandler<GetDocumentSmsByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentSmsByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentSmsByIdQuery request,
