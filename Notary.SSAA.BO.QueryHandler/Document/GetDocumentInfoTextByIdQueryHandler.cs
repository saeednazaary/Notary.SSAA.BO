...
{
    public class GetDocumentInfoTextByIdQueryHandler
        : BaseQueryHandler<GetDocumentInfoTextByIdQuery, ApiResult<DocumentViewModel>>
    {
        ...
        public GetDocumentInfoTextByIdQueryHandler(
            IMediator mediator,
        ...
        protected override bool HasAccess(
            GetDocumentInfoTextByIdQuery request,
