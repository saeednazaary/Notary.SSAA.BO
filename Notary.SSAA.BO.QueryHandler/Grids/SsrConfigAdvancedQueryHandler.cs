...
{
    internal class SsrConfigAdvancedQueryHandler : BaseQueryHandler<SsrConfigAdvancedSearchQuery, ApiResult<SsrConfigAdvancedSearchGridViewModel>>
    {
        private readonly ISsrConfigRepository _advancedSearchGridRepository;

        public SsrConfigAdvancedQueryHandler(IMediator mediator, IUserService userService,
            ISsrConfigRepository advancedSearchGridRepository)
        ...
        protected override bool HasAccess(SsrConfigAdvancedSearchQuery request, IList<string> userRoles)
        {
        ...
        protected override async Task<ApiResult<SsrConfigAdvancedSearchGridViewModel>> RunAsync(SsrConfigAdvancedSearchQuery request, CancellationToken cancellationToken)
        {
            ...
            SsrConfigAdvancedSearchGrid databseResult = await _advancedSearchGridRepository.GetSsrConfigGridItems(request.PageIndex, request.PageSize,
            ...
            return new ApiResult<SsrConfigAdvancedSearchGridViewModel>(true, ApiResultStatusCode.Success, result, new List<string> { "..عملیات با موفقیت انجام شد" });
        }
    }
}
