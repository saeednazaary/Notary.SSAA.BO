...
using SSAA.Notary.DataTransferObject.Validators.EDM;

namespace Notary.SSAA.BO.WebApi.Controllers.v1
{
    [ApiVersion("1.0")]
    public class SignRequestSearchController : BaseController
    {
        public SignRequestSearchController(IMediator mediator) : base(mediator)
        {
        ...
        [Route("[action]"), Authorize]
        [HttpPost]
        public async Task<IActionResult> SignRequestDocumentTemplateSearch([FromBody] SignRequestDocumentTemplateLookupQuery query)
        {
            var validator = new SignRequestDocumentTemplateLookupValidator();
        ...
        [Route("[action]"), Authorize]
        [HttpPost]
        public async Task<IActionResult> SignRequest([FromBody] SignRequestAdvancedSearchQuery command)
        {

            var validator = new SignRequestAdvancedSearchValidator();
        ...
        [Route("[action]"), Authorize]
        [HttpPost]
        public async Task<IActionResult> SignRequestStatisticReport([FromBody] SignRequestStatisticReportQuery command)
        {

            var validator = new SignRequestStatisticReportValidator();
        ...
        [Route("[action]"), Authorize]
        [HttpPost]
        public async Task<IActionResult> SignRequestEdmReport([FromBody] SignRequestReportEdmQuery command)
        {

            var validator = new SignRequestReportEdmValidator();
