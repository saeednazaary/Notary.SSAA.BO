namespace Notary.SSAA.BO.DataTransferObject.Mappers.Document
{
    ...
    /// <summary>
    /// Defines the <see cref="DocumentTypeMapper" />
    /// </summary>
    public static class DocumentTypeMapper
    {
        /// <summary>
        /// The MapToDocumentTypeViewModel
        /// </summary>
        /// <param name="databaseResult">The databaseResult<see cref="Domain.Entities.DocumentType"/></param>
        /// <returns>The <see cref="DocumentTypeViewModel"/></returns>
        public static DocumentTypeViewModel MapToDocumentTypeViewModel ( Domain.Entities.DocumentType databaseResult )
        {
            var config = new TypeAdapterConfig();

            config.NewConfig<Domain.Entities.DocumentType, DocumentTypeViewModel> ()
            ...
            return databaseResult.Adapt<DocumentTypeViewModel> ( config );
        }
    }
}
