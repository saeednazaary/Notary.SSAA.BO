namespace Notary.SSAA.BO.DataTransferObject.Mappers.Document
{
    ...
    /// <summary>
    /// Defines the <see cref="DocumentPersonMapper" />
    /// </summary>
    public static class DocumentPersonMapper
    {
        /// <summary>
        /// The MapToDocumentPerson
        /// </summary>
        /// <param name="DocumentPerson">The DocumentPerson<see cref="DocumentPerson"/></param>
        /// <param name="viewModel">The viewModel<see cref="DocumentPersonViewModel"/></param>
        public static void MapToDocumentPerson(ref DocumentPerson DocumentPerson, DocumentPersonViewModel viewModel)
        {
            var config = new TypeAdapterConfig();
            config.NewConfig<DocumentPersonViewModel, DocumentPerson>()
        ...
        /// <summary>
        /// The MapToDocumentPeopleViewModel
        /// </summary>
        ...
        public static List<DocumentPersonViewModel> MapToDocumentPeopleViewModel(
        List<DocumentPerson> documentPeople
    )
        {
            List<DocumentPersonViewModel> documentPeopleViewModel =
                new List<DocumentPersonViewModel>();
            documentPeople.ForEach(sp =>
            {
                documentPeopleViewModel.Add(MapToDocumentPersonViewModel(sp));
            });
            return documentPeopleViewModel;
        }

        /// <summary>
        /// The MapToDocumentPersonViewModel
        /// </summary>
        /// <param name="documentPerson">The documentPerson<see cref="DocumentPerson"/></param>
        /// <returns>The <see cref="DocumentPersonViewModel"/></returns>
        public static DocumentPersonViewModel MapToDocumentPersonViewModel(
      ...
      )
        {
            ...
            config
                .NewConfig<DocumentPerson, DocumentPersonViewModel>()
            ...
            var documentPersonViewModel = documentPerson.Adapt<DocumentPersonViewModel>(config);
