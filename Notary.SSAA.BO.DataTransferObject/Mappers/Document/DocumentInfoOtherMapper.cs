namespace Notary.SSAA.BO.DataTransferObject.Mappers.Document
{
    ...
    /// <summary>
    /// Defines the <see cref="DocumentInfoOtherMapper" />
    /// </summary>
    public static class DocumentInfoOtherMapper
    {
        /// <summary>
        /// The MapToDocumentInfoOtherViewModel
        /// </summary>
        /// <param name="databaseResult">The databaseResult<see cref="Domain.Entities.DocumentInfoOther"/></param>
        /// <returns>The <see cref="DocumentInfoOtherViewModel"/></returns>
        public static DocumentInfoOtherViewModel MapToDocumentInfoOtherViewModel ( Domain.Entities.DocumentInfoOther databaseResult )
        {
            var config = new TypeAdapterConfig();

            config.NewConfig<Domain.Entities.DocumentInfoOther, DocumentInfoOtherViewModel> ()
                ...
                .Map ( dest => dest.MortageTimeUnitId, src => src.MortageTimeUnitId != null
                            ...
                            : new List<string> () );
            return databaseResult.Adapt<DocumentInfoOtherViewModel> ( config );
        }

        /// <summary>
        /// The MapToDocumentInfoOther
        /// </summary>
        /// <param name="documentInfoOther">The documentInfoOther<see cref="DocumentInfoOther"/></param>
        /// <param name="viewModel">The viewModel<see cref="DocumentInfoOtherViewModel"/></param>
        public static void MapToDocumentInfoOther ( ref DocumentInfoOther documentInfoOther, DocumentInfoOtherViewModel viewModel )
        {
            var config = new TypeAdapterConfig();
            config.NewConfig<DocumentInfoOtherViewModel, DocumentInfoOther> ()
