...
{
    public class GetDocumentStandardContractSignDataQuery : BaseQueryRequest<ApiResult<SignDataViewModel>>
    {
        public GetDocumentStandardContractSignDataQuery(string documentId)
        {
