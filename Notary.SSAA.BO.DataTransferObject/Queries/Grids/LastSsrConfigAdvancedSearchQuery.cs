...
{
    public class LastSsrConfigAdvancedSearchQuery : BaseQueryRequest<ApiResult<SsrConfigAdvancedSearchGridViewModel>>
    {
        public LastSsrConfigAdvancedSearchQuery()
        {
        ...
        public SsrConfigGridExtraParams ExtraParams { get; set; }
    }
}
