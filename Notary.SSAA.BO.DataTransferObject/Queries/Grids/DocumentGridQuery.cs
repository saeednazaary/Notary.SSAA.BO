...
{
    public sealed class DocumentGridQuery : BaseQueryRequest<ApiResult<DocumentGridViewModel>>
    {
        public DocumentGridQuery()
        {
        ...
        public DocumentExtraParams Extraparams { get; set; }
    }
