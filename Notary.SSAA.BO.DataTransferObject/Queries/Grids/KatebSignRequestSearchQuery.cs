...
{
    public class KatebSignRequestSearchQuery : BaseQueryRequest<ApiResult<KatebSignRequestGridViewModel>>
    {
        public KatebSignRequestSearchQuery()
        {
        ...
        public KatebSignRequestSearchExtraParams ExtraParams { get; set; }
    }
}
