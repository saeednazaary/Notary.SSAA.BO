...
{
    public class ElzamArtSixGridQuery : BaseQueryRequest<ApiResult<ElzamArtSixGridViewModel>>
    {
        public ElzamArtSixGridQuery()
        {
        ...
        public ElzamArtSixGridExtraParams ExtraParams { get; set; }
    }
}