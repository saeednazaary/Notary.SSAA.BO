...
{
    public class SignRequestAdminAdvancedSearchQuery : BaseQueryRequest<ApiResult<SignRequestGridViewModel>>
    {
        public SignRequestAdminAdvancedSearchQuery()
        {
        ...
        public SignRequestAdminSearchExtraParams ExtraParams { get; set; }
    }
}
