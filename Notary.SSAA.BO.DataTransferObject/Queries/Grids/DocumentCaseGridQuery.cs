...
{
    public class DocumentCaseGridQuery : BaseQueryRequest<ApiResult<DocumentCaseGridViewModel>>
    {
        public DocumentCaseGridQuery()
        {
        ...
        public DocumentCaseExtraParams ExtraParams { get; set; }
    }
}
