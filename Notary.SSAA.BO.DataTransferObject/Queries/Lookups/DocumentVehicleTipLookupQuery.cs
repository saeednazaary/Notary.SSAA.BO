...
{
    public class DocumentVehicleTipLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public DocumentVehicleTipLookupQuery()
        {
        ...
        public DocumentVehicleTipExtraParams ExtraParams { get; set; }
    }
}
