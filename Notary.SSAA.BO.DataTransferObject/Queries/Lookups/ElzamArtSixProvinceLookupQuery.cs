...
{
    public sealed class ElzamArtSixProvinceLookupQuery : BaseQueryRequest<ApiResult<ElzamArtSixProvinceLookupRepositoryObject>>
    {
        public ElzamArtSixProvinceLookupQuery()
        {
        ...
        public ElzamArtSixProvinceLookupExtraParams ExtraParams { get; set; }
    }
}