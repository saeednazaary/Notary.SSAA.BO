...
{
    public sealed class DocumentAssetTypeLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public DocumentAssetTypeLookupQuery()
        {
        ...
        public DocumentAssetTypeLookupExtraParams ExtraParams { get; set; }
