...
{
    public class DocumentEstateTypeLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public DocumentEstateTypeLookupQuery()
        {
        ...
        public DocumentEstateTypeExtraParams ExtraParams { get; set; }
    }
}
