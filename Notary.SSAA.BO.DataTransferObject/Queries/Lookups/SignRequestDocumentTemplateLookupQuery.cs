...
{
    public sealed class SignRequestDocumentTemplateLookupQuery : BaseQueryRequest<ApiResult<SignRequestDocumentTemplateRepositoryObject>>
    {
        public SignRequestDocumentTemplateLookupQuery()
        {
        ...
        public DocumentTemplateLookupExtraParams ExtraParams { get; set; }
