...
{
    public class DocumentPersonLookupQuery : BaseQueryRequest<ApiResult<DocumentDetailPersonLookupRepositoryObject>>
    {
        public DocumentPersonLookupQuery()
        {
        ...
        public DocumentDetailPersonExteraParams ExtraParams { get; set; }
    }
