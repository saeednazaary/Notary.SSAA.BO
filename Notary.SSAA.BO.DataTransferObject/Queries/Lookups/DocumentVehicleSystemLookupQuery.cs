...
{
    public class DocumentVehicleSystemLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public DocumentVehicleSystemLookupQuery()
        {
        ...
        public DocumentVehicleSystemExtraParams ExtraParams { get; set; }
    }
}
