...
{
    public class ExecutiveRequestDocumentTypeLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public ExecutiveRequestDocumentTypeLookupQuery()
        {
