...
{
    public sealed class DocumentTypeGroupTwoLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public DocumentTypeGroupTwoLookupQuery()
        {
        ...
        public DocumentTypegroupTwoExtraParams ExtraParams { get; set; }
