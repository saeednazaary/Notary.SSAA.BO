...
{
    public class CostTypeLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public CostTypeLookupQuery()
        {
        ...
        public DocumentCostTypeLookupExtraParams ExtraParams { get; set; }
    }
}
