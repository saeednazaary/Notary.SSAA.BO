...
{
    public class DocumentAgentTypeLookupQuery : BaseQueryRequest<ApiResult<DocumentAgentTypeLookupRepositoryObject>>
    {
        public DocumentAgentTypeLookupQuery()
        {
        ...
        public DocumentAgentTypeLookupExtraParams ExtraParams { get; set; }
