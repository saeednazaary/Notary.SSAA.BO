...
{
    public class SignRequestReliablePersonReasonLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public SignRequestReliablePersonReasonLookupQuery()
        {
        ...
        public SignRequestReliablePersonReasonLookupExtraParams ExtraParams { get; set; }
    }
}
