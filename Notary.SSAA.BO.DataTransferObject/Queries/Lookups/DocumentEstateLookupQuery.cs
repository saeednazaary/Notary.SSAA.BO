...
{
    public class DocumentEstateLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public DocumentEstateLookupQuery()
        {
        ...
        public DocumentEstateLookupExtraParams ExtraParams { get; set; }
    }
}
