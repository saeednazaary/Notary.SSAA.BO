...
{
    public class DocumentOriginalPersonLookupQuery : BaseQueryRequest<ApiResult<DocumentPersonLookupRepositoryObject>>
    {
        public DocumentOriginalPersonLookupQuery()
        {
            GridSortInput = new List<SortData>();
            GridFilterInput = new List<SearchData>();
            SelectedItems = new List<string>();
            ExtraParams = new DocumentPersonExteraParams();

        }
        public IList<string> SelectedItems { get; set; }
        public DocumentPersonExteraParams ExtraParams { get; set; }
