...
{
    public class ExecutiveSupportAddressTypeLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public ExecutiveSupportAddressTypeLookupQuery()
        {
