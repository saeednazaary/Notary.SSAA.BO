...
{
    public class SsrConfigSubjectLookupQuery : BaseQueryRequest<ApiResult<SsrConfigSubjectLookupRepositoryObject>>
    {
        public SsrConfigSubjectLookupQuery()
        {
        ...
        public SsrConfigSubjectExtraParams ExtraParams { get; set; }
    }
