...
{
    public sealed class ElzamArtSixCountyLookupQuery : BaseQueryRequest<ApiResult<ElzamArtSixCountyLookupRepositoryObject>>
    {
        public ElzamArtSixCountyLookupQuery()
        {
        ...
        public ElzamArtSixCountyLookupExtraParams ExtraParams { get; set; }
    }
}