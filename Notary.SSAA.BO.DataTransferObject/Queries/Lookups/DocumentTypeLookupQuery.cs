...
{
    public sealed class DocumentTypeLookupQuery : BaseQueryRequest<ApiResult<DocumentTypeRepositoryObject>>
    {
        public DocumentTypeLookupQuery()
        {
        ...
        public DocumentTypeExtraParams ExtraParams { get; set; }
