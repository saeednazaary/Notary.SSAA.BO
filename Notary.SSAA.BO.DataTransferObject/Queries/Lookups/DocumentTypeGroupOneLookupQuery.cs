...
{
    public sealed class DocumentTypeGroupOneLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public DocumentTypeGroupOneLookupQuery()
        {
        ...
        public DocumentTypegroupOneExtraParams extraParams { get; set; }
