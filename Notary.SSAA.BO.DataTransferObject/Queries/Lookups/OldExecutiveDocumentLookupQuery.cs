...
{
    public sealed class OldExecutiveDocumentLookupQuery : BaseQueryRequest<ApiResult<OldExecutiveDocumentLookupRepositoryObject>>
    {
        public OldExecutiveDocumentLookupQuery()
        {
        ...
        public OldExecutiveDocumentSearchExtraParams ExtraParams { get; set; }
