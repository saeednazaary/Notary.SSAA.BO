...
{
    public sealed class DocumentTypeSubjectLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public DocumentTypeSubjectLookupQuery()
        {
        ...
        public DocumentTypeSubjectLookupExtraParams ExtraParams { get; set; }
