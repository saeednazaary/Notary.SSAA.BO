...
{
    public class DocumentInquiryOrganizationLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public DocumentInquiryOrganizationLookupQuery()
        {
