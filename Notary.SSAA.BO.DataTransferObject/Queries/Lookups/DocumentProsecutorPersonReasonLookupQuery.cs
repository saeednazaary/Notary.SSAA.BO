...
{
    public class DocumentProsecutorPersonReasonLookupQuery : BaseQueryRequest<ApiResult<DocumentProsecutorPersonReasonLookupRepositoryObject>>
    {
        public DocumentProsecutorPersonReasonLookupQuery()
        {
