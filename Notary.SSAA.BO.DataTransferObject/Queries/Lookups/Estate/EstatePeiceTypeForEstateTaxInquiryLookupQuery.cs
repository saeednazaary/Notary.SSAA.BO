...
{
    public class EstatePeiceTypeForEstateTaxInquiryLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public EstatePeiceTypeForEstateTaxInquiryLookupQuery()
        {
