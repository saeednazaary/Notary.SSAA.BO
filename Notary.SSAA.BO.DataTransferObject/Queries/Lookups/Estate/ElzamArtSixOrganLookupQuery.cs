...
{
    public class ElzamArtSixOrganLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public ElzamArtSixOrganLookupQuery()
        {
        ...
        public ElzamArtSixOrganLookupQueryExtraParam ExtraParams { get; set; }
    }
    public class ElzamArtSixOrganLookupQueryExtraParam
    {
    }
}
