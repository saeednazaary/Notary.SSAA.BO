...
{
    public class DealSummaryPersonRelationTypeForTaxInquiryLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public DealSummaryPersonRelationTypeForTaxInquiryLookupQuery()
        {
