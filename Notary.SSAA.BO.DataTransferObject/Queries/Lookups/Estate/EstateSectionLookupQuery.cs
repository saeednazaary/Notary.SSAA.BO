...
{
    public class EstateSectionLookupQuery : BaseQueryRequest<ApiResult<EstateSctionLookupViewModel>>
    {
        public EstateSectionLookupQuery()
        {
        ...
        public EstateSectionLookupQueryExtraParam ExtraParams { get; set; }
    }

    public class EstateSectionLookupQueryExtraParam
    {
