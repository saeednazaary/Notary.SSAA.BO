...
{
    public class EstateTaxCityLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public EstateTaxCityLookupQuery()
        {
        ...
        public EstateTaxCityLookupQueryExtraParam ExtraParams { get; set; }
    }

    public class EstateTaxCityLookupQueryExtraParam
    {
