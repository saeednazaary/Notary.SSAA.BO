...
{
    public class EstateTaxLocationAssignRigthUsingTypeLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public EstateTaxLocationAssignRigthUsingTypeLookupQuery()
        {
