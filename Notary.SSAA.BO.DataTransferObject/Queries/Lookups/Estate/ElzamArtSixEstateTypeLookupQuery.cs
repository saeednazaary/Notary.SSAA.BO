...
{
    public sealed class ElzamArtSixEstateTypeLookupQuery : BaseQueryRequest<ApiResult<ElzamArtSixEstateTypeLookupRepositoryObject>>
    {
        public ElzamArtSixEstateTypeLookupQuery()
        {
        ...
        public ElzamArtSixEstateTypeLookupExtraParams ExtraParams { get; set; }
    }
}