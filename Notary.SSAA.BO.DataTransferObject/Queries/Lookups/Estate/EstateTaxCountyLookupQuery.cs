...
{
    public class EstateTaxCountyLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public EstateTaxCountyLookupQuery()
        {
        ...
        public EstateTaxCountyLookupQueryExtraParam ExtraParams { get; set; }
    }

    public class EstateTaxCountyLookupQueryExtraParam
    {
