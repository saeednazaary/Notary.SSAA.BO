...
{
    public class EstateInquiryForDivisionRequestLookupQuery : BaseQueryRequest<ApiResult<EstateInquiryGrid2>>
    {
        public EstateInquiryForDivisionRequestLookupQuery()
        {
        ...
        public EstateInquiryForDivisionRequestLookupQueryExtraParam ExtraParams { get; set; }


    }

    public class EstateInquiryForDivisionRequestLookupQueryExtraParam
    {
