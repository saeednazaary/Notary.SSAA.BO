...
{
    public class DealSummaryPersonLookupQuery : BaseQueryRequest<ApiResult<DealSummaryPersonGrid>>
    {
        public DealSummaryPersonLookupQuery()
        {
        ...
        public DealSummaryPersonLookupQueryExtraParam ExtraParams { get; set; }

    }
    public class DealSummaryPersonLookupQueryExtraParam
    {
