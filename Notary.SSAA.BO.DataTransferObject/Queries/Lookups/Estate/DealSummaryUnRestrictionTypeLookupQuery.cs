...
{
    public class DealSummaryUnRestrictionTypeLookupQuery : BaseQueryRequest<ApiResult<DealSummaryUnRestrictionTypeLookupViewModel>>
    {
        public DealSummaryUnRestrictionTypeLookupQuery()
        {
