...
{
    public sealed class ElzamArtSixEstateUsingLookupQuery : BaseQueryRequest<ApiResult<ElzamArtSixEstateUsingLookupRepositoryObject>>
    {
        public ElzamArtSixEstateUsingLookupQuery()
        {
        ...
        public ElzamArtSixEstateUsingLookupExtraParams ExtraParams { get; set; }
    }
}