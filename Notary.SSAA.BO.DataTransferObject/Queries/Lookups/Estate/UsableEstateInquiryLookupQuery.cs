...
{
    public class UsableEstateInquiryLookupQuery : BaseQueryRequest<ApiResult<EstateInquiryGrid2>>
    {
        public UsableEstateInquiryLookupQuery()
        {
        ...
        public UsableEstateInquiryLookupQueryLookupQueryExtraParam ExtraParams { get; set; }


    }

    public class UsableEstateInquiryLookupQueryLookupQueryExtraParam
    {
