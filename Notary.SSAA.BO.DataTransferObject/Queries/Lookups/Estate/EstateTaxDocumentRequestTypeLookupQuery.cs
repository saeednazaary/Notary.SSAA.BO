...
{
    public class EstateTaxDocumentRequestTypeLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public EstateTaxDocumentRequestTypeLookupQuery()
        {
