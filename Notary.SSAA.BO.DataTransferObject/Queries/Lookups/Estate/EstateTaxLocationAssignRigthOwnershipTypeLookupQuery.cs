...
{
    public class EstateTaxLocationAssignRigthOwnershipTypeLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public EstateTaxLocationAssignRigthOwnershipTypeLookupQuery()
        {
