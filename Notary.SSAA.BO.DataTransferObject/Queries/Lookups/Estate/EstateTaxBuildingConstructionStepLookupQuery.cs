...
{
    public class EstateTaxBuildingConstructionStepLookupQuery : BaseQueryRequest<ApiResult<BaseLookupRepositoryObject>>
    {
        public EstateTaxBuildingConstructionStepLookupQuery()
        {
