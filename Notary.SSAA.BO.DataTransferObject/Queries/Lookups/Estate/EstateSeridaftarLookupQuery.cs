...
{
    public class EstateSeridaftarLookupQuery : BaseQueryRequest<ApiResult<EstateSeriDaftarLookupViewModel>>
    {
        public EstateSeridaftarLookupQuery()
        {
        ...
        public EstateSeridaftarLookupQueryExtraParam ExtraParams { get; set; }
    }

    public class EstateSeridaftarLookupQueryExtraParam
    {
