...
{
    public class SignRequestOriginalPersonLookupQuery : BaseQueryRequest<ApiResult<SignRequestAgentPersonLookupRepositoryObject>>
    {
        public SignRequestOriginalPersonLookupQuery()
        {
