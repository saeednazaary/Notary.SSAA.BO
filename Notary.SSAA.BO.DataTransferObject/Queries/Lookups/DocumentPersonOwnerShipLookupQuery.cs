...
{
    public class DocumentPersonOwnerShipLookupQuery : BaseQueryRequest<ApiResult<DocumentPersonOwnerShipLookupRepositoryObject>>
    {
        public DocumentPersonOwnerShipLookupQuery()
        {
        ...
        public DocumentPersonOwnerShipExtraParams ExtraParams { get; set; }
    }
