...
{
    public class DocumentReliablePersonReasonLookupQuery : BaseQueryRequest<ApiResult<DocumentReliablePersonReasonLookupRepositoryObject>>
    {
        public DocumentReliablePersonReasonLookupQuery()
        {
