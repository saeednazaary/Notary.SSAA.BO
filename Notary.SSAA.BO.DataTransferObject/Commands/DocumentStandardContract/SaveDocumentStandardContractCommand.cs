namespace Notary.SSAA.BO.DataTransferObject.Commands.DocumentStandardContract
{
    ...
    /// <summary>
    /// Defines the <see cref="SaveDocumentStandardContractCommand" />
    /// </summary>
    public class SaveDocumentStandardContractCommand : BaseCommandRequest<ApiResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SaveDocumentStandardContractCommand"/> class.
        /// </summary>
        public SaveDocumentStandardContractCommand()
        {
            ...
            DocumentSms = new List<DocumentStandardContractSmsViewModel>();
        }
