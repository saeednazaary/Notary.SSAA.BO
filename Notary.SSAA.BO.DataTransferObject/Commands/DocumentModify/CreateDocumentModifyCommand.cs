...
namespace Notary.SSAA.BO.DataTransferObject.Commands.DocumentModify
{
    public class CreateDocumentModifyCommand : BaseCommandRequest<ApiResult>
    {
        public CreateDocumentModifyCommand()
        {
