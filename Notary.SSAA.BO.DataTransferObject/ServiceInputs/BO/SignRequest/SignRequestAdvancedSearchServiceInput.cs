...
public class SignRequestAdvancedSearchServiceInput : BaseExternalRequest<ApiResult<SignRequestGridViewModel>>
{
    public SignRequestAdvancedSearchServiceInput()
    {
    ...
    public SignRequestSearchExtraParams ExtraParams { get; set; }
}
