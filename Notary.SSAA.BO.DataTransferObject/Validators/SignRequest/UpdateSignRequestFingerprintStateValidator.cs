...
{
    public class UpdateSignRequestFingerprintStateValidator : AbstractValidator<UpdateSignRequestFingerprintStateCommand>
    {
        public UpdateSignRequestFingerprintStateValidator()
        {
