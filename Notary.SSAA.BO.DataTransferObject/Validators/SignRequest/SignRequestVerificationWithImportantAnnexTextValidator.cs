...
{
    public class SignRequestVerificationWithImportantAnnexTextValidator : AbstractValidator<SignRequestVerificationWithImportantAnnexTextQuery>
    {
        public SignRequestVerificationWithImportantAnnexTextValidator()
        {
