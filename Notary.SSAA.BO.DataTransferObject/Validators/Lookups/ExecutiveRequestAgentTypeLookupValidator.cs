...
{
    public class ExecutiveRequestAgentTypeLookupValidator : AbstractValidator<ExecutiveRequestAgentTypeLookupQuery>
    {
        public ExecutiveRequestAgentTypeLookupValidator()
        {
