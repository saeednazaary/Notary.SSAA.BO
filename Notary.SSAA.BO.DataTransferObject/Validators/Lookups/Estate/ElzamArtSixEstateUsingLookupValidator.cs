...
{
    public sealed class ElzamArtSixEstateUsingLookupValidator : AbstractValidator<ElzamArtSixEstateUsingLookupQuery>
    {
        public ElzamArtSixEstateUsingLookupValidator()
        {
