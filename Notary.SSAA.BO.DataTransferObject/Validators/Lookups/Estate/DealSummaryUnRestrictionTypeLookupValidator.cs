...
{
    public class DealSummaryUnRestrictionTypeLookupValidator : AbstractValidator<DealSummaryUnRestrictionTypeLookupQuery>
    {
        public DealSummaryUnRestrictionTypeLookupValidator()
        {
