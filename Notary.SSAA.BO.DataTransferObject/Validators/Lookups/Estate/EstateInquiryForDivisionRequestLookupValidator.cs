...
{
    public class EstateInquiryForDivisionRequestLookupValidator : AbstractValidator<EstateInquiryForDivisionRequestLookupQuery>
    {
        public EstateInquiryForDivisionRequestLookupValidator()
        {
