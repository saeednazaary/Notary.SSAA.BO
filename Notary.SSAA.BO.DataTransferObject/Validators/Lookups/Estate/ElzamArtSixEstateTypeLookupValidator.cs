...
{
    public sealed class ElzamArtSixEstateTypeLookupValidator : AbstractValidator<ElzamArtSixEstateTypeLookupQuery>
    {
        public ElzamArtSixEstateTypeLookupValidator()
        {
