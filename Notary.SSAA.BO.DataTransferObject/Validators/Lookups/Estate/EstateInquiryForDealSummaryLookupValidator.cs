...
{
    public class EstateInquiryForDealSummaryLookupValidator : AbstractValidator<EstateInquiryForDealSummaryLookupQuery>
    {
        public EstateInquiryForDealSummaryLookupValidator()
        {
