...
{
    public sealed class ReusedDocumentPaymentLookupValidator : AbstractValidator<ReusedDocumentPaymentLookupQuery>
    {
        public ReusedDocumentPaymentLookupValidator()
        {
