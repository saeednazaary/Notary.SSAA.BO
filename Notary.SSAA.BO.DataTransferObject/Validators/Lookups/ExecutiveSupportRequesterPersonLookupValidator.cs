...
{
    public class ExecutiveSupportRequesterPersonLookupValidator : AbstractValidator<ExecutiveSupportRequesterPersonLookupQuery>
    {
        public ExecutiveSupportRequesterPersonLookupValidator()
        {
