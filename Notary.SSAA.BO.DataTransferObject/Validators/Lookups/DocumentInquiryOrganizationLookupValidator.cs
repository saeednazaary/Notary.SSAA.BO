...
{
    public sealed class DocumentInquiryOrganizationLookupValidator : AbstractValidator<DocumentInquiryOrganizationLookupQuery>
    {
        public DocumentInquiryOrganizationLookupValidator()
        {
