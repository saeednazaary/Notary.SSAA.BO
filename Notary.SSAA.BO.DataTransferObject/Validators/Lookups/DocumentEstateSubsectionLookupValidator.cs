...
{
    public sealed class DocumentEstateSubsectionLookupValidator : AbstractValidator<DocumentEstateSubsectionLookupQuery>
    {
        public DocumentEstateSubsectionLookupValidator()
        {
