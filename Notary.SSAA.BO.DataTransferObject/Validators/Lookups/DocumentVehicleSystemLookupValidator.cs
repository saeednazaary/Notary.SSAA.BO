...
{
    public sealed class DocumentVehicleSystemLookupValidator : AbstractValidator<DocumentVehicleSystemLookupQuery>
    {
        public DocumentVehicleSystemLookupValidator()
        {
