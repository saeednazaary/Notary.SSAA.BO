...
{
    public class ExecutiveSupportAddressTypeLookupValidator : AbstractValidator<ExecutiveSupportAddressTypeLookupQuery>
    {
        public ExecutiveSupportAddressTypeLookupValidator()
        {
