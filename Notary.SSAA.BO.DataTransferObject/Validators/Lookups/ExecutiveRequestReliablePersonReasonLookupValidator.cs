...
{
    public class ExecutiveRequestReliablePersonReasonLookupValidator : AbstractValidator<ExecutiveRequestReliablePersonReasonLookupQuery>
    {
        public ExecutiveRequestReliablePersonReasonLookupValidator()
        {
            ...
            RuleFor(e => e.ExtraParams.ExtraParam)
                .NotEmpty().WithMessage("نوع وابستگی اجباری است");
        }
    }
}
