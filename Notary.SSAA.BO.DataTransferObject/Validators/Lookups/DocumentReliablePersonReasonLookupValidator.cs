...
{
    public class DocumentReliablePersonReasonLookupValidator : AbstractValidator<DocumentReliablePersonReasonLookupQuery>
    {
        public DocumentReliablePersonReasonLookupValidator()
        {
