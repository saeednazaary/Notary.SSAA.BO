...
{
    public class ExecutiveRequestRelatedPersonLookupValidator : AbstractValidator<ExecutiveRequestRelatedPersonLookupQuery>
    {
        public ExecutiveRequestRelatedPersonLookupValidator()
        {
            ...
            RuleFor(v => v.PageSize)
             ...
             .NotNull().WithMessage(SystemMessagesConstant.Grid_PageIndex_Required);
            RuleFor(e => e.ExtraParams.ExtraParam).NotNull().WithMessage("شناسه تقاضانامه خالی می باشد");
        }
    }
}
