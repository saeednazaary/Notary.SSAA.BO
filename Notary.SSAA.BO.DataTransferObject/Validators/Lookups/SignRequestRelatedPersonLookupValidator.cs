...
{
    public class SignRequestRelatedPersonLookupValidator : AbstractValidator<SignRequestRelatedPersonLookupQuery>
    {
        public SignRequestRelatedPersonLookupValidator()
        {
