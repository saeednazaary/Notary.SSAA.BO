...
{
    public class DocumentProsecutorPersonReasonLookupValidator : AbstractValidator<DocumentProsecutorPersonReasonLookupQuery>
    {
        public DocumentProsecutorPersonReasonLookupValidator()
        {
