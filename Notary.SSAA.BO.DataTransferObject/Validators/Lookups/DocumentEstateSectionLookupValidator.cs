...
{
    public sealed class DocumentEstateSectionLookupValidator : AbstractValidator<DocumentEstateSectionLookupQuery>
    {
        public DocumentEstateSectionLookupValidator()
        {
