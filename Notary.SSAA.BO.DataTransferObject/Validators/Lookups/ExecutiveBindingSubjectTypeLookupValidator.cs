...
{
    public class ExecutiveBindingSubjectTypeLookupValidator : AbstractValidator<ExecutiveBindingSubjectTypeLookupQuery>
    {
        public ExecutiveBindingSubjectTypeLookupValidator()
        {
