...
{
    public class SignRequestReliablePersonReasonLookupValidator : AbstractValidator<SignRequestReliablePersonReasonLookupQuery>
    {
        public SignRequestReliablePersonReasonLookupValidator()
        {
