...
{
    public class OtherPaymentsTypeLookupValidator : AbstractValidator<OtherPaymentsTypeLookupQuery>
    {
        public OtherPaymentsTypeLookupValidator()
        {
            ...
            RuleFor(v => v.PageSize)
             ...
             .NotNull().WithMessage(SystemMessagesConstant.Grid_PageIndex_Required);
            RuleForEach(v => v.SelectedItems).Must(ValidatorHelper.BeValidNumber).WithMessage("شناسه آیتم انتخاب شده معتبر نیست . ");
        }
    }
}
