...
{
    public sealed class DocumentEstateSeridaftarLookupValidator : AbstractValidator<DocumentEstateSeridaftarLookupQuery>
    {
        public DocumentEstateSeridaftarLookupValidator()
        {
