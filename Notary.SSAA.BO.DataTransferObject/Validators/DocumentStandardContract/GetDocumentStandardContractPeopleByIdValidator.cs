...
{
    public class GetDocumentStandardContractPeopleByIdValidator
        : AbstractValidator<GetDocumentStandardContractPeopleByIdQuery>
    {
        public GetDocumentStandardContractPeopleByIdValidator ( )
        {
