...
{
    public class GetDocumentStandardContractRelatedPeopleByIdValidator
        : AbstractValidator<GetDocumentStandardContractRelatedPeopleByIdQuery>
    {
        public GetDocumentStandardContractRelatedPeopleByIdValidator()
        {
