...
{
    public class GetDocumentStandardContractInquiriesByIdValidator
        : AbstractValidator<GetDocumentStandardContractInquiriesByIdQuery>
    {
        public GetDocumentStandardContractInquiriesByIdValidator( )
        {
