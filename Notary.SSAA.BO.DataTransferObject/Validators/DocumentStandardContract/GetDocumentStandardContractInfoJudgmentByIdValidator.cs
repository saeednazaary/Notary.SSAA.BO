...
{
    public class GetDocumentStandardContractInfoJudgmentByIdValidator : AbstractValidator<GetDocumentStandardContractInfoJudgmentByIdQuery>
    {
        public GetDocumentStandardContractInfoJudgmentByIdValidator()
        {
