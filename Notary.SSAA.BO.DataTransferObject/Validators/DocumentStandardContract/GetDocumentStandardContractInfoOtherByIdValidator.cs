...
{
    public class GetDocumentStandardContractInfoOtherByIdValidator : AbstractValidator<GetDocumentStandardContractInfoOtherByIdQuery>
    {
        public GetDocumentStandardContractInfoOtherByIdValidator()
        {
