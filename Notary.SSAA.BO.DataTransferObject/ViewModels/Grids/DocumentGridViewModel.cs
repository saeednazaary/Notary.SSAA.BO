...
namespace Notary.SSAA.BO.DataTransferObject.ViewModels.Grids
{
    public sealed class DocumentGridViewModel
    {
        ...
        public List<DocumentGridItemViewModel> GridItems { get; set; }
        public List<DocumentGridItemViewModel> SelectedItems { get; set; }
    }
    public class DocumentGridItemViewModel
    {
