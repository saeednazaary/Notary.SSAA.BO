...
namespace Notary.SSAA.BO.DataTransferObject.ViewModels.Services.ExternalServices
{
    public class FindLastFingerprintServiceViewModel
    {
        public FindLastFingerprintServiceViewModel()
        {
