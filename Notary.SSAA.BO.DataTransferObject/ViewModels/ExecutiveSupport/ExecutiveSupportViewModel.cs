...
{
    public class ExecutiveSupportViewModel : BaseCommandRequest<ApiResult>
    {
        public ExecutiveSupportViewModel()
        {
            ExecutionSupportiveTypeId = new List<string>();
            RequesterPersonId = new List<string>();
            ExecutiveSupportivePersons = new List<ExecutiveSupportPersonViewModel>();
        ...
        [System.ComponentModel.DisplayName("عنوان اجرائیه")]
        [System.ComponentModel.Description("عنوان اجرائیه")]
        ...
        [System.ComponentModel.DisplayName("عنوان نوع خدمات تبعی اجرائیه")]
        [System.ComponentModel.Description("عنوان نوع خدمات تبعی اجرائیه")]
        public string ExecutionSupportiveTypeName { get; set; }
        ...
        [System.ComponentModel.DisplayName("نام واحد ثبتی دریافت کننده درخواست")]
        [System.ComponentModel.Description("نام واحد ثبتی دریافت کننده درخواست")]
        public string ExecutionSupportiveUnitName { get; set; }
        ...
        [System.ComponentModel.DisplayName("نام واحد ثبتی پاسخ دهنده درخواست")]
        [System.ComponentModel.Description("نام واحد ثبتی پاسخ دهنده درخواست")]
        public string ExecutionSupportiveReplyUnitName { get; set; }
        ...
        [System.ComponentModel.DisplayName("شناسه پرونده")]
        [System.ComponentModel.Description("شناسه پرونده")]
        public string ExecutionCaseId { get; set; }
        ...
        public List<ExecutiveSupportPersonViewModel> ExecutiveSupportivePersons { get; set; }
