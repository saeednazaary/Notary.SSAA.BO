...
{
    public class DocumentVehicleViewModel : EntityState
    {
        public DocumentVehicleViewModel()
        {
        ...
        public IList<DocumentVehicleQuotumViewModel> DocumentVehicleQuotums { get; set; }
        public IList<DocumentVehicleQuotaDetailViewModel> DocumentVehicleQuotaDetails { get; set; }

    }

    public partial class DocumentVehicleQuotumViewModel : EntityState
    {
    ...
    public partial class DocumentVehicleQuotaDetailViewModel : EntityState
    {
