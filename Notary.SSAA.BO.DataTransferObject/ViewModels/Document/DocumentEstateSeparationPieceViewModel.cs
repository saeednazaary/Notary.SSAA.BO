...
{
    public class DocumentEstateSeparationPieceViewModel : EntityState
    {
        ...
        public IList<DocumentEstateSeparationPiecesQuotaViewModel> DocumentEstateSeparationPiecesQuotaList { get; set; }
    }
    public class DocumentSeparationPiecesParkingViewModel : EntityState
    {
    ...
    public class DocumentSeparationPiecesAnbariViewModel : EntityState
    {
    ...
    public class DocumentEstateSeparationPiecesQuotaViewModel : EntityState
    {
