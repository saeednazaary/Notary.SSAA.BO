...
{
    public class DocumentStandardContractEstateViewModel : EntityState
    {
        /// <summary>
        ...
        public IList<DocumentStandardContractEstateOwnerShipViewModel> DocumentEstateOwnerShips { get; set; }
        public IList<DocumentStandardContractEstateAttachmentViewModel> DocumentEstateAttachments { get; set; }
        public IList<DocumentStandardContractEstateSeparationPieceViewModel> DocumentEstateSeparationPieces { get; set; }
        public IList<DocumentStandardContractEstateQuotumViewModel> DocumentEstateQuotums { get; set; }
        public IList<DocumentStandardContractEstateQuotaDetailViewModel> DocumentEstateQuotaDetails { get; set; }
