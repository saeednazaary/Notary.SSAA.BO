...
{
    public class DocumentStandardContractRelatedPersonViewModel : EntityState
    {
        public DocumentStandardContractRelatedPersonViewModel()
        {
        ...
        public  bool isMotamed(DocumentStandardContractRelatedPersonViewModel documentRelatedPerson)
        {
            return 
                  RelatedAgentTypeId != null &&
                  RelatedAgentTypeId.Count > 0 &&
