...
namespace Notary.SSAA.BO.Coordinator.NotaryDocument
{
    ...
    /// <summary>
    /// Defines the <see cref="LoadDocumentStandardContractCoordinator" />
    /// </summary>
    public class LoadDocumentStandardContractCoordinator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoadDocumentStandardContractCoordinator"/> class.
        /// </summary>
        ...
        public LoadDocumentStandardContractCoordinator(IUserService _userService, ILogger _logger, ValidatorGateway _validatorGateway
    ...
    IHttpEndPointCaller httpEndPointCaller, ClientConfiguration clientConfiguration)
        ...
        /// <returns>The <see cref="Task{ApiResult{DocumentStandardContractViewModel}}"/></returns>
        public async Task<ApiResult<DocumentStandardContractViewModel>> LoadDocumentDetail(string documentId, string detailName, CaseType caseType,
            ...
            if (!string.IsNullOrEmpty(detailName))
            {
                ...
                if (detailName == DocumentDatailName.RelationDocument.GetString())
                {
                    ...
                    if (document != null)
                    {
                        ...
                        DocumentStandardContractRelationViewModel documentRelationViewModel = new DocumentStandardContractRelationViewModel();
        ...
        public List<string> GetDetails(SaveDocumentStandardContractCommand request)
        {
        ...
        /// <param name="request">The request<see cref="SaveDocumentStandardContractCommand"/></param>
        /// <returns>The <see cref="List{string}"/></returns>
        public List<string> GetCopyDetails(SaveDocumentStandardContractCommand request)
        {
            List<string> detailsList = new List<string>();
