...
namespace Notary.SSAA.BO.Coordinator.NotaryDocument.Core.Commons
{
    public class PersonInquiryManager
    {
        ...
        public async Task<(List<ApiResult<SabtAhvalServiceViewModel>>, List<ApiResult<GetGeolocationByNationalityCodeViewModel>>,bool ,string)>  GetPersonInfo ( List<InputPerson> inputPersons,CancellationToken cancellationToken, string extraParam = null )
        {
        ...
        public async Task<ApiResult<SabtAhvalServiceViewModel>> GetPersonData (string nationalCode,string birthDate,CancellationToken cancellationToken )
        {
            ...
            var sabtAhvalServiceResult = await _httpExternalServiceCaller.CallExternalServicePostApiAsync<ApiResult<SabtAhvalServiceViewModel>, SabteAhvalInput>(new HttpExternalServiceRequest<SabteAhvalInput>
