...
namespace Notary.SSAA.BO.Coordinator.NotaryDocument
{
    ...
    /// <summary>
    /// Defines the <see cref="SaveDocumentCoordinator" />
    /// </summary>
    public class SaveDocumentCoordinator
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SaveDocumentCoordinator"/> class.
        /// </summary>
        ...
        /// <param name="_loadDocumentCoordinator">The _loadDocumentCoordinator<see cref="LoadDocumentCoordinator"/></param>
        ...
        public SaveDocumentCoordinator(IMediator mediator, IUserService _userService, ILogger _logger, ValidatorGateway _validatorGateway
            ...
            , LoadDocumentCoordinator _loadDocumentCoordinator, EstateInquiryEngine estateInquiryEngine, ClientConfiguration clientConfiguration, MessagingCore messagingCore
        ...
        /// <param name="saveDocumentCommand">The saveDocumentCommand<see cref="SaveDocumentCommand"/></param>
       ...
       theOneRelatedPerson.IsRelatedDocumentInSsar == null)
        ...
        public (bool, List<string>) ValidateDocumentViewModel(SaveDocumentCommand request)
        {
        ...
        /// <param name="cancellationToken">The cancellationToken<see cref="CancellationToken"/></param>
        /// <returns>The <see cref="Task"/></returns>
        public async Task MapToDocument(SaveDocumentCommand request, CancellationToken cancellationToken)
        {
            if (request.IsRequestInSetNationalDocumentNo() || request.IsRequestInFinalized())
                return;
            DocumentMapper.MapToDocument(ref document, request);
            ...
            if (request.DocumentPeople?.Count > 0)
            {
                ...
                foreach (DocumentPersonViewModel DocumentPersonViewModel in request.DocumentPeople)
                {
                    if (DocumentPersonViewModel.IsNew)
                    {
                        DocumentPerson newDocumentPerson = new();
                        DocumentPersonMapper.MapToDocumentPerson(ref newDocumentPerson, DocumentPersonViewModel);
                        newDocumentPerson.ScriptoriumId = document.ScriptoriumId;
                        newDocumentPerson.RowNo = newCounter;
                        newDocumentPerson.Ilm = DocumentConstants.UpdateIlm;
                        ...
                        {
                            newDocumentPerson.HasGrowthJudgment = DocumentPersonViewModel.HasGrowthJudgment.ToYesNo();
                            newDocumentPerson.GrowthDescription = DocumentPersonViewModel.GrowthDescription;
                            newDocumentPerson.GrowthJudgmentDate = DocumentPersonViewModel.GrowthJudgmentDate;
                            newDocumentPerson.GrowthJudgmentNo = DocumentPersonViewModel.GrowthJudgmentNo;
                            newDocumentPerson.GrowthLetterDate = DocumentPersonViewModel.GrowthLetterDate;
                            newDocumentPerson.GrowthLetterNo = DocumentPersonViewModel.GrowthLetterNo;
                        }
                        else
                        {
                            newDocumentPerson.HasGrowthJudgment = DocumentPersonViewModel.HasGrowthJudgment.ToYesNo();
                        ...
                        if (DocumentPersonViewModel.IsMartyrApplicant == true)
                        {
                            ...
                            newDocumentPerson.IsMartyrIncluded = DocumentPersonViewModel.MartyrIsIncluded.ToYesNo();
                            if (!string.IsNullOrEmpty(DocumentPersonViewModel.MartyrInquiryDateTime))
                            {
                                ...
                                {
                                    newDocumentPerson.MartyrInquiryDate = DocumentPersonViewModel.MartyrInquiryDateTime.Substring(0, 10);
                                    newDocumentPerson.MartyrInquiryTime = DocumentPersonViewModel.MartyrInquiryDateTime.Substring(10);
                                }
                                else
                                {
                                    newDocumentPerson.MartyrInquiryDate = DocumentPersonViewModel.MartyrInquiryDateTime;

                                }
                            }
                            newDocumentPerson.MartyrInquiryDate = DocumentPersonViewModel.MartyrInquiryDateTime;
                            newDocumentPerson.MartyrCode = DocumentPersonViewModel.MartyrCode;
                            newDocumentPerson.MartyrDescription = DocumentPersonViewModel.MartyrDescription;
                        }
                        else
                        {
                            newDocumentPerson.IsMartyrApplicant =
                        ...
                        if (DocumentPersonViewModel.IsDirty)
                        {
                    ...
                    else if (DocumentPersonViewModel.IsDelete)
                    {
                        _ = document.DocumentPeople.Remove(
                            document.DocumentPeople.First(x => x.Id == DocumentPersonViewModel.PersonId.ToGuid()));
                        isDeletePersonRequest = true;

                    }
                    else if (!DocumentPersonViewModel.IsDirty)
                    {
                ...
                IList<DocumentPersonViewModel> documentPeopleDirty =
                ...
                foreach (DocumentPerson dbDocumentPerson in dbDocumentPeople)
                {
                    ...
                    DocumentPersonViewModel? documentPersonViewModel =
                        documentPeopleDirty.FirstOrDefault(pd => pd.PersonId == updatingDocumentPerson.Id.ToString());
                    if (documentPersonViewModel != null)
                    {
                        DocumentPersonMapper.MapToDocumentPerson(ref updatingDocumentPerson, documentPersonViewModel);
                        if (documentPersonViewModel.HasGrowthJudgment == true)
                        {
            ...
            if (request.DocumentRelatedPeople?.Count > 0)
            {
                ...
                foreach (DocumentRelatedPersonViewModel DocumentRelatedPersonViewModel in request.DocumentRelatedPeople)
                {
                    if (DocumentRelatedPersonViewModel.IsNew)
                    {
                        ...
                        DocumentRelatedPersonMapper.MapToDocumentRelatedPerson(ref newDocumentPersonRelated,
                        ...
                        if (DocumentRelatedPersonViewModel.IsDirty)
                        {
                    ...
                    else if (DocumentRelatedPersonViewModel.IsDelete)
                    {
                        _ = document.DocumentPersonRelatedDocuments.Remove(
                            document.DocumentPersonRelatedDocuments.First(x =>
                                x.Id == DocumentRelatedPersonViewModel.RelatedPersonId.ToGuid()));
                        isDeletePersonRequest = true;
                    }

                    else if (!DocumentRelatedPersonViewModel.IsDirty)
                    {
                ...
                IList<DocumentRelatedPersonViewModel> documentRelatedPersonDirty = request.DocumentRelatedPeople
                ...
                foreach (DocumentPersonRelated dbDocumentRelatedPerson in dbDocumentRelatedPeople)
                {
                    ...
                    DocumentRelatedPersonViewModel? documentEstateViewModel =
                    ...
                    {
                        DocumentRelatedPersonMapper.MapToDocumentRelatedPerson(ref updatingDocumentRelatedPerson,
                            documentEstateViewModel);
            ...
            if (request.DocumentEstates?.Count > 0)
            {
                ...
                foreach (DocumentEstateViewModel DocumentEstateViewModel in request.DocumentEstates)
                {
                    if (DocumentEstateViewModel.IsNew)
                    {
                        DocumentEstate newDocumentEstate = new();
                        DocumentEstateMapper.MapToDocumentEstate(ref newDocumentEstate, DocumentEstateViewModel);
                        ...
                        if (DocumentEstateViewModel.IsDirty)
                        {

                        }

                        if (DocumentEstateViewModel.DocumentEstateOwnerShips?.Count > 0)
                        {
                            ...
                            if (newDocumentEstate.DocumentEstateOwnershipDocuments?.Count > 0)
                                rowNoMaxOwnerShip = newDocumentEstate.DocumentEstateOwnershipDocuments.Count <=
                                    ...
                                    : newDocumentEstate.DocumentEstateOwnershipDocuments.Count - DocumentEstateViewModel
                            ...
                            foreach (DocumentEstateOwnerShipViewModel documentEstateOwnerShipViewModel in
                                     DocumentEstateViewModel.DocumentEstateOwnerShips)
                            {
                                if (documentEstateOwnerShipViewModel.IsNew)
                                {
                                    ...
                                    DocumentEstateMapper.MapToDocumentEstate(ref documentEstateOwnershipDocument,
                                        documentEstateOwnerShipViewModel);
                        ...
                        if (DocumentEstateViewModel.DocumentEstateAttachments?.Count > 0)
                        {
                            ...
                            short newCounterAttachment =
                                (short)(DocumentEstateViewModel.DocumentEstateAttachments.Where(x => x.IsNew).Count() +
                                        rowNoMaxAttachment);
                            ...
                            foreach (DocumentEstateAttachmentViewModel documentEstateAttachmentViewModel in
                                     DocumentEstateViewModel.DocumentEstateAttachments)
                            {
                                if (documentEstateAttachmentViewModel.IsNew)
                                {
                                    ...
                                    DocumentEstateMapper.MapToDocumentEstateAttachment(ref documentEstateAttachment,
                        ...
                        if (DocumentEstateViewModel.DocumentEstateSeparationPieces?.Count > 0)
                        {

                            foreach (DocumentEstateSeparationPieceViewModel documentEstateSeparationViewModel in
                                     DocumentEstateViewModel.DocumentEstateSeparationPieces)
                            {
                                if (documentEstateSeparationViewModel.IsNew)
                                {
                                    ...
                                    DocumentEstateMapper.MapToDocumentEstate(ref documentEstateSeparation,
                                    ...
                                    if (documentEstateSeparationViewModel.DocumentEstateSeparationPiecesQuotaList?.Count > 0)
                                    {
                                        ...
                                        foreach (DocumentEstateSeparationPiecesQuotaViewModel documentEstateQuotumViewModel in
                                                 documentEstateSeparationViewModel.DocumentEstateSeparationPiecesQuotaList)
                                        {
                                            if (documentEstateQuotumViewModel.IsNew)
                                            {
                                                ...
                                                DocumentEstateMapper.MapToDocumentEstateSeparationPiecesQuotam(ref documentEstateQuotum,
                        ...
                        if (DocumentEstateViewModel.DocumentEstateQuotums?.Count > 0)
                        {

                            foreach (DocumentEstateQuotumViewModel documentEstateQuotumViewModel in
                                     DocumentEstateViewModel.DocumentEstateQuotums)
                            {
                                if (documentEstateQuotumViewModel.IsNew)
                                {
                                    DocumentEstateQuotum documentEstateQuotum = new();
                                    DocumentEstateMapper.MapToDocumentEstateQuotum(ref documentEstateQuotum,
                                        documentEstateQuotumViewModel);
                        ...
                        if (DocumentEstateViewModel.DocumentEstateQuotaDetails?.Count > 0)
                        {

                            foreach (DocumentEstateQuotaDetailViewModel documentEstateQuotaDetailViewModel in
                                     DocumentEstateViewModel.DocumentEstateQuotaDetails)
                            {
                                if (documentEstateQuotaDetailViewModel.IsNew)
                                {
                                    ...
                                    DocumentEstateMapper.MapToDocumentEstateQuotaDetail(ref documentEstateQuotaDetail,
                    ...
                    else if (DocumentEstateViewModel.IsDelete)
                    {
                        document.DocumentEstates.First(x => x.Id == DocumentEstateViewModel.EstateId.ToGuid())
                    ...
                    else if (!DocumentEstateViewModel.IsDirty)
                    {
                    ...
                    foreach (var item in DocumentEstateViewModel.DocumentEstateAttachments)
                    {
                    ...
                    foreach (var documentEstateOwnerShip in DocumentEstateViewModel.DocumentEstateOwnerShips)
                    {
                    ...
                    foreach (var documentEstateSeparation in DocumentEstateViewModel.DocumentEstateSeparationPieces)
                    {
                    ...
                    foreach (var documentEstateQuotaDetail in DocumentEstateViewModel.DocumentEstateQuotaDetails)
                    {
                    ...
                    foreach (var documentEstateQuotum in DocumentEstateViewModel.DocumentEstateQuotums)
                    {
                ...
                IList<DocumentEstateViewModel> documentEstatesDirty =
                ...
                foreach (DocumentEstate dbDocumentEstate in dbDocumentEstates)
                {
                    ...
                    DocumentEstateViewModel? documentEstateViewModel =
                        documentEstatesDirty.FirstOrDefault(pd => pd.EstateId == updatingDocumentEstate.Id.ToString());
                    if (documentEstateViewModel != null)
                    {
                        DocumentEstateMapper.MapToDocumentEstate(ref updatingDocumentEstate, documentEstateViewModel);
                            ...
                            documentEstateViewModel.DocumentEstateOwnerShips?.Count > 0)
                        {
                            ...
                            IList<DocumentEstateOwnerShipViewModel> documentEstateOwnerShipsDirty =
                                documentEstateViewModel.DocumentEstateOwnerShips
                                    .Where(p => p.IsDirty && !p.IsNew && !p.IsDelete).ToList();
                            ...
                            if (dbDocumentEstateOwnerShips != null)
                            {
                                         ...
                                         dbDocumentEstateOwnerShips)
                                {
                                    ...
                                    {
                                        DocumentEstateOwnerShipViewModel? documentEstateOwnerShipViewModel =
                                            documentEstateOwnerShipsDirty.FirstOrDefault(pd =>
                                                pd.EstateOwnerShipId == updatingDocumentEstateOwnerShip.Id.ToString());

                                        if (documentEstateViewModel != null)
                                        {
                                            DocumentEstateMapper.MapToDocumentEstate(
                                                ref updatingDocumentEstateOwnerShip, documentEstateOwnerShipViewModel);
                            ...
                            documentEstateViewModel.DocumentEstateSeparationPieces?.Count > 0)
                        {
                                     ...
                                     documentEstateViewModel.DocumentEstateSeparationPieces)
                            {
                                    ...
                                    if (updatingDocumentEstate?.DocumentEstateSeparationPieces != null && documentEstateSeparationViewModel.DocumentEstateSeparationPiecesQuotaList?.Count > 0)
                                    {
                                                 ...
                                                 documentEstateSeparationViewModel.DocumentEstateSeparationPiecesQuotaList)
                                        {
                                            ...
                                            else if (documentEstateQuotumViewModel.IsDirty)
                                            {
                                                ...
                                                DocumentEstateMapper.MapToDocumentEstateSeparationPiecesQuotam(ref updatingDocumentEstateQuotum,
                                                    documentEstateQuotumViewModel);
                                ...
                                else if (documentEstateSeparationViewModel.IsDirty)
                                {
                                    ...
                                    DocumentEstateMapper.MapToDocumentEstate(ref updatingDocumentEstateSeparation, documentEstateSeparationViewModel);
                            ...
                            documentEstateViewModel.DocumentEstateAttachments?.Count > 0)
                        {
                                     ...
                                     documentEstateViewModel.DocumentEstateAttachments)
                            {
                                ...
                                else if (documentEstateAttachmentViewModel.IsDirty)
                                {
                                    ...
                                    DocumentEstateMapper.MapToDocumentEstateAttachment(
                        ...
                        if (updatingDocumentEstate != null && documentEstateViewModel.DocumentEstateQuotums?.Count > 0)
                        {
                                     ...
                                     documentEstateViewModel.DocumentEstateQuotums)
                            {
                                ...
                                else if (documentEstateQuotumViewModel.IsDirty)
                                {
                                    ...
                                    DocumentEstateMapper.MapToDocumentEstateQuotum(ref updatingDocumentEstateQuotum,
                                        documentEstateQuotumViewModel);
                            ...
                            documentEstateViewModel.DocumentEstateQuotaDetails?.Count > 0)
                        {
                                     ...
                                     documentEstateViewModel.DocumentEstateQuotaDetails)
                            {
                                ...
                                else if (documentEstateQuotaDetailViewModel.IsDirty)
                                {
                                    ...
                                    DocumentEstateMapper.MapToDocumentEstateQuotaDetail(
            ...
            if (request.DocumentVehicles?.Count > 0)
            {
                ...
                foreach (DocumentVehicleViewModel DocumentVehicleViewModel in request.DocumentVehicles)
                {
                    if (DocumentVehicleViewModel.IsNew)
                    {
                        DocumentVehicle newDocumentVehicle = new();
                        DocumentVehicleMapper.MapToDocumentVehicle(ref newDocumentVehicle, DocumentVehicleViewModel);
                        ...
                        if (DocumentVehicleViewModel.IsDirty)
                        {
                    ...
                    else if (DocumentVehicleViewModel.IsDelete)
                    {

                        _ = document.DocumentVehicles.Remove(
                            document.DocumentVehicles.First(x => x.Id == DocumentVehicleViewModel.VehicleId.ToGuid()));
                        isDeletePersonRequest = true;

                    }

                    else if (!DocumentVehicleViewModel.IsDirty)
                    {
                    ...
                    foreach (var documentVehicleQuotaDetail in DocumentVehicleViewModel.DocumentVehicleQuotaDetails)
                    {
                        if (documentVehicleQuotaDetail.IsDelete == true)
                        {
                            ...
                            //  .Where ( x => x.Id == DocumentVehicleViewModel.VehicleId.ToGuid ()  )
                            //  .FirstOrDefault ().DocumentVehicleQuotaDetails.Remove ( document.DocumentVehicles
                            //  .Where ( x => x.Id == DocumentVehicleViewModel.VehicleId.ToGuid () ).FirstOrDefault ()
                            //  .DocumentVehicleQuotaDetails.FirstOrDefault ( q => q.Id == documentVehicleQuotaDetail.DocumentVehicleQuotaDetailId.ToGuid () ) );

                        }
                    }

                    foreach (var documentVehicleQuotum in DocumentVehicleViewModel.DocumentVehicleQuotums)
                    {
                ...
                IList<DocumentVehicleViewModel> DocumentVehiclesDirty =
                ...
                foreach (DocumentVehicle dbDocumentVehicle in dbDocumentVehicles)
                {
                    ...
                    DocumentVehicleViewModel? DocumentVehicleViewModel =
                        DocumentVehiclesDirty.FirstOrDefault(
                            pd => pd.VehicleId == updatingDocumentVehicle.Id.ToString());
                    if (DocumentVehicleViewModel != null)
                    {
                        DocumentVehicleMapper.MapToDocumentVehicle(ref updatingDocumentVehicle,
                            DocumentVehicleViewModel);
            ...
            if (request.DocumentCases?.Count > 0)
            {
                ...
                foreach (DocumentCaseViewModel DocumentCaseViewModel in request.DocumentCases)
                {
                    if (DocumentCaseViewModel.IsNew)
                    {
                        DocumentCase newDocumentCase = new();
                        DocumentCaseMapper.MapToDocumentCase(ref newDocumentCase, DocumentCaseViewModel);
                ...
                IList<DocumentCaseViewModel> DocumentCasesDirty =
                ...
                foreach (DocumentCase dbDocumentCase in dbDocumentCases)
                {
                    ...
                    DocumentCaseViewModel? DocumentCaseViewModel =
                        DocumentCasesDirty.FirstOrDefault(pd =>
                            pd.DocumentCaseId == updatingDocumentCase.Id.ToString());
                    if (DocumentCaseViewModel != null)
                    {
                        DocumentCaseMapper.MapToDocumentCase(ref updatingDocumentCase, DocumentCaseViewModel);
            ...
            if (request.DocumentInfoJudgment != null)
            {
                ...
                if (request.DocumentInfoJudgment.IsNew)
                {
                    ...
                    DocumentInfoJudgmentMapper.MapToDocumentInfoJudgment(ref newDocumentInfoJudgment,
                        request.DocumentInfoJudgment);
                ...
                else if (request.DocumentInfoJudgment.IsDirty)
                {
                    ...
                    DocumentInfoJudgmentMapper.MapToDocumentInfoJudgment(ref updatingDocumentInfoJudgment,
                        request.DocumentInfoJudgment);
                }
                else
                {
            ...
            if (!(request.IsCopyDocumentInfoText == true && !string.IsNullOrEmpty(request.DocumentCopyId)))
            {
                if (request.DocumentInfoText != null)
                {
                    ...
                    if (request.DocumentInfoText.IsNew)
                    {
                        ...
                        DocumentInfoTextMapper.MapToDocumentInfoText(ref newDocumentInfoText, request.DocumentInfoText);
                    ...
                    else if (request.DocumentInfoText.IsDirty)
                    {
                        ...
                        DocumentInfoTextMapper.MapToDocumentInfoText(ref updatingDocumentInfoText,
            ...
            if (request.DocumentInfoOther != null)
            {
                if (request.DocumentInfoOther.IsNew)
                {
                    ...
                    DocumentInfoOtherMapper.MapToDocumentInfoOther(ref newDocumentInfoOther, request.DocumentInfoOther);
                ...
                else if (request.DocumentInfoOther.IsDirty)
                {
                    ...
                    DocumentInfoOtherMapper.MapToDocumentInfoOther(ref updatingDocumentInfoOther,
            ...
            {
                foreach (DocumentRelationViewModel DocumentRelationViewModel in request.DocumentRelations)
                {

                    if (DocumentRelationViewModel.IsNew)
                    {

                        DocumentRelation newDocumentRelation = new();
                        DocumentRelationMapper.MapToDocumentRelation(ref newDocumentRelation,
                    ...
                    else if (DocumentRelationViewModel.IsDelete)
                    {
                        _ = document.DocumentRelationDocuments.Remove(
                            document.DocumentRelationDocuments.First(x =>
                                x.Id == DocumentRelationViewModel.RelatedtId.ToGuid()));
                    }
                    else if (DocumentRelationViewModel.IsDirty)
                    {

                        DocumentRelation updatingDocumentRelation =
                            document.DocumentRelationDocuments.First(x =>
                                x.Id == DocumentRelationViewModel.RelatedtId.ToGuid());
                        DocumentRelationMapper.MapToDocumentRelation(ref updatingDocumentRelation,
                            DocumentRelationViewModel);
            ...
            if (request.DocumentMainRelation != null)
            {
                if (request.DocumentMainRelation.IsDirty == true)
                {
                    ...
                    DocumentRelationMapper.MapToDocumentMainRelation(ref document, request.DocumentMainRelation);
            ...
            {
                foreach (DocumentInquiryViewModel documentInquiryViewModel in request.DocumentInquiries)
                {
                    if (documentInquiryViewModel.IsNew)
                    {
                        DocumentInquiry newDocumentInquiry = new();
                        DocumentInquiriesMapper.MapToDocumentInquiry(ref newDocumentInquiry, documentInquiryViewModel);
                    ...
                    else if (documentInquiryViewModel.IsDirty)
                    {
                        DocumentInquiry updatingDocumentInquiry =
                            document.DocumentInquiries.First(x =>
                                x.Id == documentInquiryViewModel.DocumentInquiryId.ToGuid());
                        DocumentInquiriesMapper.MapToDocumentInquiry(ref updatingDocumentInquiry,
                ...
                foreach (DocumentCostViewModel DocumentCostViewModel in request.DocumentCosts)
                {
                    if (DocumentCostViewModel.IsNew)
                    {
                        ...
                        if (!string.IsNullOrEmpty(DocumentCostViewModel.RequestPriceUnchanged))
                        {
                            ...
                            DocuemntCostMapper.MapToDocumentCostUnchanged(ref documentCostUnchanged,
                    ...
                    else if (DocumentCostViewModel.IsDirty)
                    {
                        ...
                        DocuemntCostMapper.MapToDocumentCost(ref updatingDocumentCost, DocumentCostViewModel);
                        if (!string.IsNullOrEmpty(DocumentCostViewModel.RequestPriceUnchanged))
                        {
                            DocumentCostUnchanged updatingDocumentCostUnchanged =
                                document.DocumentCostUnchangeds.First(x =>
                                    x.Id == DocumentCostViewModel.RequestUnchangedId.ToGuid());
                            DocuemntCostMapper.MapToDocumentCostUnchanged(ref updatingDocumentCostUnchanged,
                                DocumentCostViewModel);
                        }
                    }
                    else
            ...
            {
                foreach (DocumentPaymentViewModel documentPaymentViewModel in request.DocumentPayments)
                {
                    DocumentPayment documentPayment = new();

                    if (documentPaymentViewModel.IsNew)
                    {
                        DocumentPaymentMapper.MapToDocumentPayment(ref documentPayment, documentPaymentViewModel, document.ScriptoriumId);
    ...
    theOneDocPerson.IsAlive == YesNo.Yes.GetString()
        ...
        public async Task<ONotaryRegisterServiceReqInputMessage> PrepareSardaftarConfirmInput(
         SaveDocumentCommand saveDocumentCommand, CancellationToken cancellationToken)
        {
    ...
    /// <summary>
    /// Defines the <see cref="PersonPair" />
    /// </summary>
    public class PersonPair
    {
        ...
        /// <summary>
        /// Gets or sets the PersonCopyId
        /// </summary>
        public Guid? PersonCopyId { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="PersonPair"/> class.
        /// </summary>
        /// <param name="personId">The personId<see cref="Guid"/></param>
        /// <param name="personCopyID">The personCopyID<see cref="Guid?"/></param>
        public PersonPair(Guid personId, Guid? personCopyID)
        {
            PersonId = personId;
            PersonCopyId = personCopyID;
        }
    }
}
